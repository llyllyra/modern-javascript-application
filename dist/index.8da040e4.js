...
})({"3JrbZ":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "70219da78da040e4";
...
},{}],"9MdVg":[function(require,module,exports) {
/*!
 * Chart.js v3.8.0
 ...
 */ !function(t, e) {
    ...
    "use strict";
    const t1 = "undefined" == typeof window ? function(t) {
        return t();
    } : window.requestAnimationFrame;
    function e1(e, i, s2) {
        const n = s2 || ((t)=>Array.prototype.slice.call(t));
        let o = !1, a = [];
        return function(...s) {
            a = n(s), o || (o = !0, t1.call(window, ()=>{
                o = !1, e.apply(i, a);
            }));
        };
    }
    ...
    const s1 = (t)=>"start" === t ? "left" : "end" === t ? "right" : "center", n1 = (t, e, i)=>"start" === t ? e : "end" === t ? i : (e + i) / 2, o1 = (t, e, i, s)=>t === (s ? "left" : "right") ? i : "center" === t ? (e + i) / 2 : e;
    var a1 = new class {
        constructor(){
            this._request = null, this._charts = new Map, this._running = !1, this._lastDate = void 0;
        }
        _notify(t, e, i, s3) {
            const n = e.listeners[s3], o = e.duration;
            n.forEach((s)=>s({
                    chart: t,
                    initial: e.initial,
                    numSteps: o,
        ...
        _refresh() {
            this._request || (this._running = !0, this._request = t1.call(window, ()=>{
        ...
        start(t2) {
            ...
            e2 && (e2.running = !0, e2.start = Date.now(), e2.duration = e2.items.reduce((t, e)=>Math.max(t, e._duration), 0), this._refresh());
        }
        running(t) {
 ...
 */ function r1(t) {
    ...
    const l1 = (t, e, i)=>Math.max(Math.min(t, i), e);
    function h1(t) {
        return l1(r1(2.55 * t), 0, 255);
    }
    function c1(t) {
        return l1(r1(255 * t), 0, 255);
    }
    function d1(t) {
        return l1(r1(t / 2.55) / 100, 0, 1);
    }
    function u1(t) {
        return l1(r1(100 * t), 0, 100);
    }
    const f1 = {
        0: 0,
        1: 1,
        ...
        ..."0123456789ABCDEF"
    ], p1 = (t)=>g1[15 & t], m1 = (t)=>g1[(240 & t) >> 4] + g1[15 & t], b1 = (t)=>(240 & t) >> 4 == (15 & t);
    function x1(t3) {
        var e3 = ((t)=>b1(t.r) && b1(t.g) && b1(t.b) && b1(t.a))(t3) ? p1 : m1;
        return t3 ? "#" + e3(t3.r) + e3(t3.g) + e3(t3.b) + ((t, e)=>t < 255 ? e(t) : "")(t3.a, e3) : void 0;
    }
    const _1 = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
    function y1(t, e4, i) {
        const s = e4 * Math.min(i, 1 - i), n2 = (e, n = (e + t / 30) % 12)=>i - s * Math.max(Math.min(n - 3, 9 - n, 1), -1);
        return [
            n2(0),
            n2(8),
            n2(4)
    ...
    function v1(t, e, i) {
        const s4 = (s, n = (s + t / 60) % 6)=>i - i * e * Math.max(Math.min(n, 4 - n, 1), 0);
        return [
            s4(5),
            s4(3),
            s4(1)
    ...
    function M1(t4) {
        const e5 = t4.r / 255, i2 = t4.g / 255, s5 = t4.b / 255, n3 = Math.max(e5, i2, s5), o = Math.min(e5, i2, s5), a = (n3 + o) / 2;
        let r, l, h;
        return n3 !== o && (h = n3 - o, l = a > .5 ? h / (2 - n3 - o) : h / (n3 + o), r = function(t, e, i, s, n) {
            return t === n ? (e - i) / s + (e < i ? 6 : 0) : e === n ? (i - t) / s + 2 : (t - e) / s + 4;
        }(e5, i2, s5, h, n3), r = 60 * r + .5), [
            0 | r,
            l || 0,
            a
        ];
    ...
    function k1(t, e, i, s) {
        return (Array.isArray(e) ? t(e[0], e[1], e[2]) : t(e, i, s)).map(c1);
    }
    function S1(t, e, i) {
        return k1(y1, t, e, i);
    }
    ...
    function D1(t5) {
        ...
        let i3, s = 255;
        if (!e6) return;
        e6[5] !== i3 && (s = e6[6] ? h1(+e6[5]) : c1(+e6[5]));
        const n = P1(+e6[2]), o = +e6[3] / 100, a = +e6[4] / 100;
        return i3 = "hwb" === e6[1] ? function(t, e, i) {
            return k1(w1, t, e, i);
        }(n, o, a) : "hsv" === e6[1] ? function(t, e, i) {
            return k1(v1, t, e, i);
        }(n, o, a) : S1(n, o, a), {
            r: i3[0],
            g: i3[1],
    ...
    function T(t6) {
        A1 || (A1 = function() {
            const t = {}, e = Object.keys(O1), i = Object.keys(C1);
            let s, n, o, a, r;
            for(s = 0; s < e.length; s++){
                for(a = r = e[s], n = 0; n < i.length; n++)o = i[n], r = r.replace(o, C1[o]);
                o = parseInt(O1[a], 16), t[r] = [
                    o >> 16 & 255,
                    o >> 8 & 255,
                    255 & o
                ];
        ...
        const e7 = A1[t6.toLowerCase()];
        return e7 && {
            r: e7[0],
            g: e7[1],
            b: e7[2],
            a: 4 === e7.length ? e7[3] : 255
        };
    }
    const L = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/;
    const R = (t)=>t <= .0031308 ? 12.92 * t : 1.055 * Math.pow(t, 1 / 2.4) - .055, E = (t)=>t <= .04045 ? t / 12.92 : Math.pow((t + .055) / 1.055, 2.4);
    function I(t, e, i) {
        if (t) {
            let s = M1(t);
            s[e] = Math.max(0, Math.min(s[e] + s[e] * i, 0 === e ? 360 : 1)), s = S1(s), t.r = s[0], t.g = s[1], t.b = s[2];
        }
    }
    function z(t, e) {
    ...
    function B(t7) {
        return "r" === t7.charAt(0) ? function(t) {
            const e = L.exec(t);
            let i, s, n, o = 255;
            if (e) {
                if (e[7] !== i) {
                    const t = +e[7];
                    o = e[8] ? h1(t) : l1(255 * t, 0, 255);
                }
                return i = +e[1], s = +e[3], n = +e[5], i = 255 & (e[2] ? h1(i) : l1(i, 0, 255)), s = 255 & (e[4] ? h1(s) : l1(s, 0, 255)), n = 255 & (e[6] ? h1(n) : l1(n, 0, 255)), {
                    r: i,
                    g: s,
                    b: n,
                    a: o
    ...
    class V {
        ...
        rgbString() {
            var t;
            return this._valid ? (t = this._rgb) && (t.a < 255 ? `rgba(${t.r}, ${t.g}, ${t.b}, ${d1(t.a)})` : `rgb(${t.r}, ${t.g}, ${t.b})`) : void 0;
        }
        hexString() {
            return this._valid ? x1(this._rgb) : void 0;
        }
        hslString() {
            return this._valid ? function(t) {
                if (!t) return;
                const e = M1(t), i = e[0], s = u1(e[1]), n = u1(e[2]);
                return t.a < 255 ? `hsla(${i}, ${s}%, ${n}%, ${d1(t.a)})` : `hsl(${i}, ${s}%, ${n}%)`;
            }(this._rgb) : void 0;
        }
        mix(t, e) {
            if (t) {
        ...
        interpolate(t8, e8) {
            return t8 && (this._rgb = function(t, e, i) {
                const s = E(d1(t.r)), n = E(d1(t.g)), o = E(d1(t.b));
                return {
                    r: c1(R(s + i * (E(d1(e.r)) - s))),
                    g: c1(R(n + i * (E(d1(e.g)) - n))),
                    b: c1(R(o + i * (E(d1(e.b)) - o))),
                    a: t.a + i * (e.a - t.a)
                };
            }(this._rgb, t8._rgb, e8)), this;
        }
        clone() {
            return new V(this.rgb);
        }
        alpha(t) {
            return this._rgb.a = c1(t), this;
        }
        clearer(t) {
            return this._rgb.a *= 1 - t, this;
        }
        greyscale() {
            const t = this._rgb, e = r1(.3 * t.r + .59 * t.g + .11 * t.b);
        ...
        rotate(t9) {
            return function(t, e) {
                var i = M1(t);
                i[0] = P1(i[0] + e), i = S1(i), t.r = i[0], t.g = i[1], t.b = i[2];
            }(this._rgb, t9), this;
        }
    }
    function N(t) {
    ...
    const J = (t, e)=>"string" == typeof t && t.endsWith("%") ? parseFloat(t) / 100 : t / e, Q = (t, e)=>"string" == typeof t && t.endsWith("%") ? parseFloat(t) / 100 * e : +t;
    function tt(t, e, i) {
    ...
    function at(t, e, i) {
        ...
        for(let a = 0; a < n; ++a){
            ...
            for(let s6 = 0, a2 = n.length; s6 < a2; ++s6)o(n[s6], t, e, i);
        }
        return t;
    }
    function rt(t, e) {
    ...
    function xt(t, e) {
        if (!e) return t;
        const i = e.split(".");
        for(let e9 = 0, s = i.length; e9 < s; ++e9){
            const s = i[e9];
    ...
    var yt = new class {
        constructor(t10){
            this.animation = void 0, this.backgroundColor = "rgba(0,0,0,0.1)", this.borderColor = "rgba(0,0,0,0.1)", this.color = "#666", this.datasets = {}, this.devicePixelRatio = (t)=>t.chart.platform.getDevicePixelRatio(), this.elements = {}, this.events = [
                ...
                intersect: !0,
                includeInvisible: !1
            }, this.maintainAspectRatio = !0, this.onHover = null, this.onClick = null, this.parsing = !0, this.plugins = {}, this.responsive = !0, this.scale = void 0, this.scales = {}, this.showLine = !0, this.drawActiveElementsOnTop = !0, this.describe(t10);
        }
        set(t, e) {
            return _t(this, t, e);
        }
        ...
        route(t11, e10, i, s) {
            const n = xt(this, t11), o = xt(this, i), a = "_" + e10;
    ...
    function vt(t, e, i4) {
        ...
        for(; n - o > 1;)s = o + n >> 1, i4(s) ? o = s : n = s;
        return {
            lo: o,
            hi: n
        };
    ...
    function Pt(t12, e11) {
        t12._chartjs ? t12._chartjs.listeners.push(e11) : (Object.defineProperty(t12, "_chartjs", {
            configurable: !0,
            enumerable: !1,
            value: {
                listeners: [
            ...
            const i = "_onData" + dt(e12), s = t12[e12];
            Object.defineProperty(t12, e12, {
                configurable: !0,
                enumerable: !1,
                value (...e) {
                    const n = s.apply(this, e);
                    return t12._chartjs.listeners.forEach((t)=>{
    ...
    function Dt(t, e13) {
        const i = t._chartjs;
        if (!i) return;
        const s = i.listeners, n = s.indexOf(e13);
    ...
    const Ot = Math.PI, At = 2 * Ot, Tt = At + Ot, Lt = Number.POSITIVE_INFINITY, Rt = Ot / 180, Et = Ot / 2, It = Ot / 4, zt = 2 * Ot / 3, Ft = Math.log10, Bt = Math.sign;
    function Vt(t) {
    ...
    function Nt(t13) {
        const e14 = [], i = Math.sqrt(t13);
        let s;
        for(s = 1; s < i; s++)t13 % s == 0 && (e14.push(s), e14.push(t13 / s));
        return i === (0 | i) && e14.push(i), e14.sort((t, e)=>t - e).pop(), e14;
    }
    function Wt(t) {
    ...
    function he(t14, e15) {
        if ("native" in t14) return t14;
        const { canvas: i5 , currentDevicePixelRatio: s7  } = e15, n4 = oe(i5), o2 = "border-box" === n4.boxSizing, a3 = le(n4, "padding"), r2 = le(n4, "border", "width"), { x: l2 , y: h , box: c  } = function(t15, e16) {
            const i6 = t15.touches, s = i6 && i6.length ? i6[0] : t15, { offsetX: n , offsetY: o  } = s;
            let a, r, l = !1;
            if (((t, e, i)=>(t > 0 || e > 0) && (!i || !i.shadowRoot))(n, o, t15.target)) a = n, r = o;
            else {
                const t = e16.getBoundingClientRect();
        ...
        }(t14, i5), d = a3.left + (c && r2.left), u = a3.top + (c && r2.top);
        let { width: f , height: g  } = e15;
        return o2 && (f -= a3.width + r2.width, g -= a3.height + r2.height), {
            x: Math.round((l2 - d) / f * i5.width / s7),
            y: Math.round((h - u) / g * i5.height / s7)
        };
    }
    const ce = (t)=>Math.round(10 * t) / 10;
    function de(t16, e17, i7, s8) {
        const n5 = oe(t16), o3 = le(n5, "margin"), a4 = ne(n5.maxWidth, t16, "clientWidth") || Lt, r3 = ne(n5.maxHeight, t16, "clientHeight") || Lt, l3 = function(t, e, i) {
            let s, n;
        ...
        let { width: h , height: c  } = l3;
        if ("content-box" === n5.boxSizing) {
            const t = le(n5, "border", "width"), e = le(n5, "padding");
            h -= e.width + t.width, c -= e.height + t.height;
        }
        return h = Math.max(0, h - o3.width), c = Math.max(0, s8 ? Math.floor(h / s8) : c - o3.height), h = ce(Math.min(h, a4, l3.maxWidth)), c = ce(Math.min(c, r3, l3.maxHeight)), h && !c && (c = ce(h / 2)), {
            width: h,
            height: c
        };
    }
    ...
    function be(t, e, i, s) {
        ...
        const r = i.length;
        let l, h, c, d, u;
        for(l = 0; l < r; l++)if (d = i[l], null != d && !0 !== X(d)) a = me(t, n, o, a, d);
    ...
    function Pe(t18, e18, i, s, n, o = {}) {
        const a = X(e18) ? e18 : [
            e18
        ], r = o.strokeWidth > 0 && "" !== o.strokeColor;
        let l, h;
        for(t18.save(), t18.font = n.string, function(t, e) {
            e.translation && t.translate(e.translation[0], e.translation[1]);
            U(e.rotation) || t.rotate(e.rotation);
            e.color && (t.fillStyle = e.color);
            e.textAlign && (t.textAlign = e.textAlign);
            e.textBaseline && (t.textBaseline = e.textBaseline);
        }(t18, o), l = 0; l < a.length; ++l)h = a[l], r && (o.strokeColor && (t18.strokeStyle = o.strokeColor), U(o.strokeWidth) || (t18.lineWidth = o.strokeWidth), t18.strokeText(h, i, s, o.maxWidth)), t18.fillText(h, i, s, o.maxWidth), De(t18, i, s, h, o), s += n.lineHeight;
        t18.restore();
    }
    ...
    function Oe(t19, e19 = [
        ...
        return new Proxy(o4, {
            deleteProperty: (e, i)=>(delete e[i], delete e._keys, delete t19[0][i], !0),
            get: (i9, s10)=>Ee(i9, s10, ()=>(function(t, e, i, s) {
                        let n;
                        for (const o of e)if (n = Ne(Le(o, t), i), ut(n)) return Re(t, n) ? Be(i, s, t, n) : n;
                    })(s10, e19, t19, i9)),
            getOwnPropertyDescriptor: (t, e)=>Reflect.getOwnPropertyDescriptor(t._scopes[0], e),
            getPrototypeOf: ()=>Reflect.getPrototypeOf(t19[0]),
            has: (t, e)=>We(t).includes(e),
            ownKeys: (t)=>We(t),
            set (t, e, i) {
                const s = t._storage || (t._storage = n6());
                return t[e] = s[e] = i, delete t._keys, !0;
            }
        });
    }
    function Ae(t20, e20, i10, s11) {
        const n7 = {
            _cacheable: !1,
            _proxy: t20,
            _context: e20,
            _subProxy: i10,
            _stack: new Set,
            _descriptors: Te(t20, s11),
            setContext: (e)=>Ae(t20, e, i10, s11),
            override: (n)=>Ae(t20.override(n), e20, i10, s11)
        };
        return new Proxy(n7, {
            deleteProperty: (e, i)=>(delete e[i], delete t20[i], !0),
            get: (t21, e21, i11)=>Ee(t21, e21, ()=>(function(t22, e22, i12) {
                        const { _proxy: s12 , _context: n8 , _subProxy: o5 , _descriptors: a5  } = t22;
                        let r4 = s12[e22];
                        ft(r4) && a5.isScriptable(e22) && (r4 = function(t, e, i, s) {
                        ...
                        X(r4) && r4.length && (r4 = function(t23, e, i, s) {
                            const { _proxy: n , _context: o , _subProxy: a , _descriptors: r  } = i;
                            if (ut(o.index) && s(t23)) e = e[o.index % e.length];
                            else if (q(e[0])) {
                                const i = e, s = n._scopes.filter((t)=>t !== i);
                                e = [];
                                for (const l of i){
                                    const i = Be(s, n, t23, l);
                                    e.push(Ae(i, o, a && a[t23], r));
                                }
                            }
                            return e;
                        }(e22, r4, t22, a5.isIndexable));
                        Re(e22, r4) && (r4 = Ae(r4, n8, o5 && o5[e22], a5));
                        return r4;
                    })(t21, e21, i11)),
            getOwnPropertyDescriptor: (e, i)=>e._descriptors.allKeys ? Reflect.has(t20, i) ? {
                    enumerable: !0,
                    configurable: !0
                } : void 0 : Reflect.getOwnPropertyDescriptor(t20, i),
            getPrototypeOf: ()=>Reflect.getPrototypeOf(t20),
            has: (e, i)=>Reflect.has(t20, i),
            ownKeys: ()=>Reflect.ownKeys(t20),
            set: (e, i, s)=>(t20[i] = s, delete e[i], !0)
        });
    }
    function Te(t, e = {
        scriptable: !0,
    ...
    const Le = (t, e)=>t ? t + dt(e) : e, Re = (t, e)=>q(e) && "adapters" !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);
    function Ee(t, e, i) {
    ...
    function Be(t24, e23, i13, s13) {
        const n9 = e23._rootScopes, o = Ie(e23._fallback, i13, s13), a = [
            ...t24,
            ...n9
        ], r = new Set;
        r.add(s13);
        let l = Ve(r, a, i13, o || i13, s13);
        return null !== l && (!ut(o) || o === i13 || (l = Ve(r, a, o, l, s13), null !== l)) && Oe(Array.from(r), [
            ""
        ], n9, o, ()=>(function(t, e, i) {
    ...
    function We(t26) {
        let e24 = t26._keys;
        return e24 || (e24 = t26._keys = function(t27) {
            const e = new Set;
            for (const i of t27)for (const t25 of Object.keys(i).filter((t)=>!t.startsWith("_")))e.add(t25);
            return Array.from(e);
        }(t26._scopes)), e24;
    }
    function He(t, e, i, s) {
    ...
    const je = Number.EPSILON || 1e-14, $e = (t, e)=>e < t.length && !t[e].skip && t[e], Ye = (t)=>"x" === t ? "y" : "x";
    function Ue(t, e, i, s) {
    ...
    function Xe(t28, e25 = "x") {
        const i14 = Ye(e25), s14 = t28.length, n10 = Array(s14).fill(0), o6 = Array(s14);
        let a6, r5, l4, h2 = $e(t28, 0);
        for(a6 = 0; a6 < s14; ++a6)if (r5 = l4, l4 = h2, h2 = $e(t28, a6 + 1), l4) {
            if (h2) {
                const t = h2[e25] - l4[e25];
                n10[a6] = 0 !== t ? (h2[i14] - l4[i14]) / t : 0;
            }
            o6[a6] = r5 ? h2 ? Bt(n10[a6 - 1]) !== Bt(n10[a6]) ? 0 : (n10[a6 - 1] + n10[a6]) / 2 : n10[a6 - 1] : n10[a6];
        }
        !function(t, e, i) {
            const s = t.length;
        ...
        }(t28, n10, o6), function(t, e, i = "x") {
            const s = Ye(i), n = t.length;
            let o, a, r, l = $e(t, 0);
            for(let h = 0; h < n; ++h){
    ...
    function Ke(t29, e26, i15, s15, n11) {
        let o7, a7, r6, l;
        if (e26.spanGaps && (t29 = t29.filter((t)=>!t.skip)), "monotone" === e26.cubicInterpolationMode) Xe(t29, n11);
        else {
            let i = s15 ? t29[t29.length - 1] : t29[0];
            for(o7 = 0, a7 = t29.length; o7 < a7; ++o7)r6 = t29[o7], l = Ue(i, r6, t29[Math.min(o7 + 1, a7 - (s15 ? 0 : 1)) % a7], e26.tension), r6.cp1x = l.previous.x, r6.cp1y = l.previous.y, r6.cp2x = l.next.x, r6.cp2y = l.next.y, i = r6;
        }
        e26.capBezierPoints && function(t, e) {
    ...
    const Ge = (t)=>0 === t || 1 === t, Ze = (t, e, i)=>-Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * At / i), Je = (t, e, i)=>Math.pow(2, -10 * t) * Math.sin((t - e) * At / i) + 1, Qe = {
        linear: (t)=>t,
        easeInQuad: (t)=>t * t,
        easeOutQuad: (t)=>-t * (t - 2),
    ...
    function ii(t, e, i, s) {
        const n = {
            ...
            x: e.cp1x,
            y: e.cp1y
        }, a = ti(t, n, i), r = ti(n, o, i), l = ti(o, e, i), h = ti(a, r, i), c = ti(r, l, i);
        return ti(h, c, i);
    }
    const si = new Map;
    function ni(t30, e27, i16) {
        return (function(t, e) {
            e = e || {};
    ...
    const oi = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/), ai = new RegExp(/^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/);
    function ri(t, e) {
        const i = ("" + t).match(oi);
    ...
    function li(t, e28) {
        const i17 = {}, s = q(e28), n = s ? Object.keys(e28) : e28, o = q(t) ? s ? (i)=>Z(t[i], t[e28[i]]) : (e)=>t[e] : ()=>t;
        for (const t31 of n)i17[t31] = +o(t31) || 0;
        return i17;
    }
    function hi(t) {
        return li(t, {
    ...
    function gi(t32, e29, i) {
        const { min: s , max: n  } = t32, o = Q(e29, (n - s) / 2), a = (t, e)=>i && 0 === t ? 0 : t + e;
        return {
            min: a(s, -Math.abs(o)),
            max: a(n, o)
        };
    ...
    function mi(t33, e30, i18) {
        return t33 ? function(t34, e31) {
            return {
                x: (i)=>t34 + t34 + e31 - i,
                setWidth (t) {
                    e31 = t;
    ...
    function vi(t37, e32, i20) {
        if (!i20) return [
            t37
        ];
        const { property: s16 , start: n12 , end: o8  } = i20, a8 = e32.length, { compare: r7 , between: l5 , normalize: h3  } = _i(s16), { start: c2 , end: d2 , loop: u2 , style: f2  } = function(t, e, i) {
            const { property: s , start: n , end: o  } = i, { between: a , normalize: r  } = _i(s), l = e.length;
        ...
        const y = ()=>x || l5(n12, b, p) && 0 !== r7(n12, b), v = ()=>!x || 0 === r7(o8, p) || l5(o8, b, p);
        for(let t36 = c2, i19 = c2; t36 <= d2; ++t36)m = e32[t36 % a8], m.skip || (p = h3(m[s16]), p !== b && (x = l5(p, n12, o8), null === _ && y() && (_ = 0 === r7(p, n12) ? t36 : i19), null !== _ && v() && (g.push(yi({
            start: _,
            end: t36,
            loop: u2,
            count: a8,
    ...
    function Mi(t38, e33) {
        const i21 = t38.points, s17 = t38.options.spanGaps, n13 = i21.length;
        if (!n13) return [];
        const o9 = !!t38._loop, { start: a9 , end: r8  } = function(t, e, i, s) {
            let n = 0, o = e - 1;
        ...
        return ki(t38, function(t, e, i, s) {
            const n = t.length, o = [];
            let a, r = e, l = t[e];
            for(a = e + 1; a <= i; ++a){
                const i = t[a % n];
        ...
        }(i21, a9, r8 < a9 ? r8 + n13 : r8, !!t38._fullLoop && 0 === a9 && r8 === n13 - 1), i21, e33);
    }
    function ki(t40, e34, i22, s18) {
        return s18 && s18.setContext && i22 ? function(t41, e35, i, s19) {
            const n14 = t41._chart.getContext(), o10 = Si(t41.options), { _datasetIndex: a , options: { spanGaps: r  }  } = t41, l = i.length, h = [];
            let c = o10, d = e35[0].start, u = d;
            function f(t, e, s, n) {
                const o = r ? -1 : 1;
                if (t !== e) {
            ...
            for (const t39 of e35){
                d = r ? d : t39.start;
                let e, o = i[d % l];
                for(u = d + 1; u <= t39.end; u++){
                    const r = i[u % l];
                    e = Si(s19.setContext(pi(n14, {
                        type: "segment",
                        p0: o,
                        p1: r,
                        p0DataIndex: (u - 1) % l,
                        p1DataIndex: u % l,
                        datasetIndex: a
                    }))), Pi(e, c) && f(d, u - 1, t39.loop, c), o = r, c = e;
                }
                d < u - 1 && f(d, u - 1, t39.loop, c);
            }
            return h;
        }(t40, e34, i22, s18) : e34;
    }
    ...
    function Oi(t, e, i, s, n) {
        ...
        for(let t42 = 0, i23 = o.length; t42 < i23; ++t42){
            const { index: i , data: r  } = o[t42], { lo: l , hi: h  } = Ci(o[t42], e, a, n);
            for(let t = l; t <= h; ++t){
                const e = r[t];
                e.skip || s(e, i, t);
            }
    ...
    function Ai(t, e, i24, s, n) {
        const o = [];
        if (!n && !t.isPointInArea(e)) return o;
        return Oi(t, i24, e, function(i, a, r) {
    ...
    function Ti(t43, e36, i25, s20, n15, o11) {
        let a = [];
        const r = function(t44) {
            const e = -1 !== t44.indexOf("x"), i = -1 !== t44.indexOf("y");
            return function(t, s) {
        ...
        return Oi(t43, i25, e36, function(i, h, c) {
            const d = i.inRange(e36.x, e36.y, n15);
            if (s20 && !d) return;
            const u = i.getCenterPoint(n15);
            if (!(!!o11 || t43.isPointInArea(u)) && !d) return;
            const f = r(e36, u);
            f < l ? (a = [
                {
                    element: i,
    ...
    function Li(t45, e37, i26, s21, n16, o12) {
        return o12 || t45.isPointInArea(e37) ? "r" !== i26 || s21 ? Ti(t45, e37, i26, s21, n16, o12) : function(t46, e, i27, s) {
            let n = [];
            return Oi(t46, i27, e, function(t, i, o) {
    ...
    function Ri(t47, e, i, s22, n) {
        const o = [], a = "x" === i ? "inXRange" : "inYRange";
        let r = !1;
        return Oi(t47, i, e, (t, s, l)=>{
            t[a](e[i], n) && (o.push({
                element: t,
                datasetIndex: s,
                index: l
    ...
    var Ei = {
        ...
        modes: {
            index (t48, e38, i28, s) {
                const n = he(e38, t48), o = i28.axis || "x", a = i28.includeInvisible || !1, r = i28.intersect ? Ai(t48, n, o, s, a) : Li(t48, n, o, !1, s, a), l = [];
                return r.length ? (t48.getSortedVisibleDatasetMetas().forEach((t)=>{
            ...
            dataset (t, e, i, s) {
                ...
                if (r.length > 0) {
                    ...
                    r = [];
                    for(let t49 = 0; t49 < i.length; ++t49)r.push({
                        element: i[t49],
                        datasetIndex: e,
                        index: t49
                    });
    ...
    function zi(t50, e) {
        return t50.filter((t)=>t.pos === e);
    }
    function Fi(t51, e) {
        return t51.filter((t)=>-1 === Ii.indexOf(t.pos) && t.box.axis === e);
    }
    function Bi(t52, e) {
        return t52.sort((t, i)=>{
    ...
    function Vi(t53, e39) {
        const i29 = function(t) {
            ...
            return e;
        }(t53), { vBoxMaxWidth: s23 , hBoxMaxHeight: n17  } = e39;
        let o13, a, r;
        for(o13 = 0, a = t53.length; o13 < a; ++o13){
            r = t53[o13];
            const { fullSize: a  } = r.box, l = i29[r.stack], h = l && r.stackWeight / l.weight;
            r.horizontal ? (r.width = h ? h * s23 : a && e39.availableWidth, r.height = n17) : (r.width = s23, r.height = h ? h * n17 : a && e39.availableHeight);
        }
        return i29;
    }
    function Ni(t, e, i, s) {
    ...
    function Hi(t, e, i, s) {
        ...
        const r = Math.max(0, e.outerWidth - Ni(a, t, "left", "right")), l = Math.max(0, e.outerHeight - Ni(a, t, "top", "bottom")), h = r !== t.w, c = l !== t.h;
    ...
    var Xi = {
        addBox (t56, e) {
            t56.boxes || (t56.boxes = []), e.fullSize = e.fullSize || !1, e.position = e.position || "top", e.weight = e.weight || 0, e._layers = e._layers || function() {
                return [
                    {
                        z: 0,
                        draw (t) {
        ...
        update (t57, e40, i30, s25) {
            if (!t57) return;
            const n18 = di(t57.options.layout.padding), o14 = Math.max(e40 - n18.width, 0), a10 = Math.max(i30 - n18.height, 0), r9 = function(t58) {
                const e41 = function(t) {
                    const e = [];
                    let i, s, n, o, a, r;
                    ...
                    return e;
                }(t58), i31 = Bi(e41.filter((t)=>t.box.fullSize), !0), s26 = Bi(zi(e41, "left"), !0), n19 = Bi(zi(e41, "right")), o15 = Bi(zi(e41, "top"), !0), a11 = Bi(zi(e41, "bottom")), r10 = Fi(e41, "x"), l = Fi(e41, "y");
                return {
                    fullSize: i31,
                    leftAndTop: s26.concat(o15),
                    rightAndBottom: n19.concat(l).concat(a11).concat(r10),
                    chartArea: zi(e41, "chartArea"),
                    vertical: s26.concat(n19).concat(l),
                    horizontal: o15.concat(a11).concat(r10)
                };
            }(t57.boxes), l6 = r9.vertical, h = r9.horizontal;
            et(t57.boxes, (t)=>{
                "function" == typeof t.beforeLayout && t.beforeLayout();
            });
            const c = l6.reduce((t, e)=>e.box.options && !1 === e.box.options.display ? t : t + 1, 0) || 1, d = Object.freeze({
                outerWidth: e40,
                outerHeight: i30,
                padding: n18,
                availableWidth: o14,
                availableHeight: a10,
                vBoxMaxWidth: o14 / 2 / c,
                hBoxMaxHeight: a10 / 2
            }), u = Object.assign({}, n18);
            Wi(u, di(s25));
            const f = Object.assign({
                ...
                x: n18.left,
                y: n18.top
            }, n18), g = Vi(l6.concat(h), d);
            $i(r9.fullSize, f, d, g), $i(l6, f, d, g), $i(h, f, d, g) && $i(l6, f, d, g), function(t) {
                const e = t.maxPadding;
                function i32(i) {
                    const s = Math.max(e[i] - t[i], 0);
                    return t[i] += s, s;
                }
                t.y += i32("top"), t.x += i32("left"), i32("right"), i32("bottom");
            }(f), Ui(r9.leftAndTop, f, d, g), f.x += f.w, f.y += f.h, Ui(r9.rightAndBottom, f, d, g), t57.chartArea = {
                left: f.left,
                top: f.top,
                right: f.left + f.w,
                bottom: f.top + f.h,
                ...
                const i = e.box;
                Object.assign(i, t57.chartArea), i.update(f.w, f.h, {
                    left: 0,
                    top: 0,
                    right: 0,
                    bottom: 0
    ...
    function es(t59, e42, i33) {
        const s = t59.canvas, n = new MutationObserver((t)=>{
            let e = !1;
    ...
    function is(t60, e43, i34) {
        const s = t60.canvas, n = new MutationObserver((t)=>{
            let e = !1;
    ...
    function as(t61, i35, s27) {
        const n = t61.canvas, o = n && se(n);
        if (!o) return;
        const a = e1((t, e)=>{
            const i = o.clientWidth;
            s27(t, e), i < o.clientWidth && s27();
    ...
    function ls(t63, i36, s28) {
        const n20 = t63.canvas, o = e1((e44)=>{
            null !== t63.ctx && s28(function(t, e) {
                const i = Gi[t.type] || t.type, { x: s , y: n  } = he(t, e);
                return {
                    type: i,
                    chart: e,
                    native: t,
    ...
    class hs extends qi {
        acquireContext(t64, e45) {
            const i37 = t64 && t64.getContext && t64.getContext("2d");
            return i37 && i37.canvas === t64 ? (function(t, e) {
        ...
        releaseContext(t65) {
            ...
            const s29 = i.style || {};
            return Object.keys(s29).forEach((t)=>{
                e.style[t] = s29[t];
    ...
    const us = "transparent", fs = {
        boolean: (t, e, i)=>i > .5 ? e : t,
        color (t, e, i) {
            const s = H(t || us), n = s.valid && H(e || us);
    ...
    class gs {
        ...
        update(t, e, i) {
            if (this._active) {
                ...
                this._start = i, this._duration = Math.floor(Math.max(o, t.duration)), this._total += n, this._loop = !!t.loop, this._to = fi([
                    t.to,
                    e,
                    s,
                    t.from
        ...
        _notify(t) {
            ...
            for(let t66 = 0; t66 < i.length; t66++)i[t66][e]();
        }
    }
    yt.set("animation", {
        delay: void 0,
    ...
    class ms {
        ...
        configure(t68) {
            ...
            Object.getOwnPropertyNames(t68).forEach((i)=>{
                const s = t68[i];
                if (!q(s)) return;
                const n = {};
                for (const t67 of ps)n[t67] = s[t67];
                (X(s.properties) && s.properties || [
                    i
                ]).forEach((t)=>{
        ...
        _animateOptions(t69, e46) {
            const i38 = e46.options, s30 = function(t, e) {
                if (!e) return;
                let i = t.options;
            ...
            if (!s30) return [];
            const n21 = this._createAnimations(s30, i38);
            return i38.$shared && (function(t, e) {
                const i = [], s = Object.keys(e);
                for(let e47 = 0; e47 < s.length; e47++){
                    const n = t[s[e47]];
                    n && n.active() && i.push(n.wait());
                }
                return Promise.all(i);
            })(t69.options.$animations, i38).then(()=>{
                t69.options = i38;
            }, ()=>{}), n21;
        }
        ...
        update(t, e) {
            ...
            return i.length ? (a1.add(this._chart, i), !0) : void 0;
        }
    }
    function bs(t, e) {
    ...
    function Ms(t71, e48) {
        const { chart: i39 , _cachedMeta: s  } = t71, n = i39._stacks || (i39._stacks = {}), { iScale: o , vScale: a , index: r  } = s, l = o.axis, h = a.axis, c = function(t, e, i) {
            return `${t.id}.${e.id}.${i.stack || i.type}`;
        }(o, a, s), d = e48.length;
        let u;
        for(let t70 = 0; t70 < d; ++t70){
            const i = e48[t70], { [l]: o , [h]: d  } = i;
    ...
    const Ps = (t)=>"reset" === t || "none" === t, Ds = (t, e)=>e ? t : Object.assign({}, t);
    class Cs {
        constructor(t, e){
        ...
        linkScales() {
            const t74 = this.chart, e49 = this._cachedMeta, i40 = this.getDataset(), s31 = (t, e, i, s)=>"x" === t ? e : "r" === t ? s : i, n = e49.xAxisID = Z(i40.xAxisID, ks(t74, "x")), o = e49.yAxisID = Z(i40.yAxisID, ks(t74, "y")), a = e49.rAxisID = Z(i40.rAxisID, ks(t74, "r")), r = e49.indexAxis, l = e49.iAxisID = s31(r, n, o, a), h = e49.vAxisID = s31(r, o, n, a);
            e49.xScale = this.getScaleForId(n), e49.yScale = this.getScaleForId(o), e49.rScale = this.getScaleForId(a), e49.iScale = this.getScaleForId(l), e49.vScale = this.getScaleForId(h);
        }
        getDataset() {
        ...
        _dataCheck() {
            const t75 = this.getDataset(), e50 = t75.data || (t75.data = []), i41 = this._data;
            if (q(e50)) this._data = function(t) {
                ...
                e50 && Object.isExtensible(e50) && Pt(e50, this), this._syncList = [], this._data = e50;
            }
        }
        addElements() {
            const t = this._cachedMeta;
        ...
        getMinMax(t76, e51) {
            const i42 = this._cachedMeta, s32 = i42._parsed, n22 = i42._sorted && t76 === i42.iScale, o = s32.length, a = this._getOtherScale(t76), r = ((t, e, i)=>t && !e.hidden && e._stacked && {
                    keys: xs(i, !0),
                    values: null
                })(e51, i42, this.chart), l = {
            ...
            function f() {
                u = s32[d];
                const e = u[a.axis];
                return !K(u[t76.axis]) || h > e || c < e;
            }
            for(d = 0; d < o && (f() || (this.updateRangeFromParsed(l, t76, u, r), !n22)); ++d);
            if (n22) {
                for(d = o - 1; d >= 0; --d)if (!f()) {
                    this.updateRangeFromParsed(l, t76, u, r);
                    break;
                }
            }
            return l;
        ...
        _update(t77) {
            const e52 = this._cachedMeta;
            this.update(t77 || "default"), e52._clip = function(t) {
                let e, i, s, n;
            ...
            }(e52.xScale, e52.yScale, this.getMaxOverflow())));
        }
        update(t) {}
        draw() {
        ...
        getContext(t78, e54, i43) {
            const s = this.getDataset();
            let n;
            if (t78 >= 0 && t78 < this._cachedMeta.data.length) {
                const e53 = this._cachedMeta.data[t78];
                n = e53.$context || (e53.$context = function(t, e, i) {
                    return pi(t, {
                        active: !1,
                        dataIndex: e,
                        parsed: void 0,
                ...
                }(this.getContext(), t78, e53)), n.parsed = this.getParsed(t78), n.raw = s.data[t78], n.index = n.dataIndex = t78;
            ...
            return n.active = !!e54, n.mode = i43, n;
        }
        ...
        _resolveElementOptions(t, e = "default", i) {
            const s = "active" === e, n = this._cachedDataOpts, o = t + "-" + e, a = n[o], r = this.enableOptionSharing && ut(i);
            if (a) return Ds(a, r);
            const l = this.chart.config, h = l.datasetElementScopeKeys(this._type, t), c = s ? [
                ...
                t,
                ""
            ], d = l.getOptionScopes(this.getDataset(), h), u = Object.keys(yt.elements[t]), f = l.resolveNamedOptions(d, u, ()=>this.getContext(i, s), c);
        ...
        _resyncElements(t) {
            ...
            for (const [t79, e55, i44] of this._syncList)this[t79](e55, i44);
            this._syncList = [];
        ...
        _insertElements(t80, e, i = !0) {
            const s = this._cachedMeta, n = s.data, o = t80 + e;
            let a;
            const r = (t)=>{
                for(t.length += e, a = t.length - 1; a >= o; a--)t[a] = t[a - e];
            };
            for(r(n), a = t80; a < o; ++a)n[a] = new this.dataElementType;
            this._parsing && r(s._parsed), this.parse(t80, e), i && this.updateElements(n, t80, e, "reset");
        }
    ...
    const As = {
        ...
        numeric (t82, e57, i45) {
            ...
            let n, o = t82;
            if (i45.length > 1) {
                const e56 = Math.max(Math.abs(i45[0].value), Math.abs(i45[i45.length - 1].value));
                (e56 < 1e-4 || e56 > 1e15) && (n = "scientific"), o = function(t, e) {
                    let i = e.length > 3 ? e[2].value - e[1].value : e[1].value - e[0].value;
                    Math.abs(i) >= 1 && t !== Math.floor(t) && (i = t - Math.floor(t));
                    return i;
                }(t82, i45);
            }
            const a = Ft(Math.abs(o)), r = Math.max(Math.min(-1 * Math.floor(a), 20), 0), l = {
                notation: n,
                minimumFractionDigits: r,
                maximumFractionDigits: r
            };
            return Object.assign(l, this.options.ticks.format), ni(t82, s, l);
        },
        logarithmic (t, e, i) {
            if (0 === t) return "0";
    ...
    function Ls(t83, e58) {
        const i46 = t83.options.ticks, s33 = i46.maxTicksLimit || function(t) {
            const e = t.options.offset, i = t._tickSize(), s = t._length / i + (e ? 0 : 1), n = t._maxLength / i;
            return Math.floor(Math.min(s, n));
        }(t83), n23 = i46.major.enabled ? function(t) {
            const e = [];
            let i, s;
            for(i = 0, s = t.length; i < s; i++)t[i].major && e.push(i);
            return e;
        }(e58) : [], o16 = n23.length, a12 = n23[0], r = n23[o16 - 1], l = [];
        if (o16 > s33) return function(t, e, i, s) {
            let n, o = 0, a = i[0];
            for(s = Math.ceil(s), n = 0; n < t.length; n++)n === a && (e.push(t[n]), o++, a = i[o * s]);
        }(e58, l, n23, o16 / s33), l;
        const h = function(t85, e60, i47) {
            const s34 = function(t) {
                const e = t.length;
                let i, s;
                if (e < 2) return !1;
                for(s = t[0], i = 1; i < e; ++i)if (t[i] - t[i - 1] !== s) return !1;
                return s;
            }(t85), n = e60.length / i47;
            if (!s34) return Math.max(n, 1);
            const o = Nt(s34);
            for(let t84 = 0, e59 = o.length - 1; t84 < e59; t84++){
                const e = o[t84];
                if (e > n) return e;
            }
            return Math.max(n, 1);
        ...
        if (o16 > 0) {
            let t, i;
            const s = o16 > 1 ? Math.round((r - a12) / (o16 - 1)) : null;
            for(Rs(e58, l, h, U(s) ? 0 : a12 - s, a12), t = 0, i = o16 - 1; t < i; t++)Rs(e58, l, h, n23[t], n23[t + 1]);
            return Rs(e58, l, h, r, U(s) ? e58.length : r + s), l;
        }
        return Rs(e58, l, h), l;
    }
    ...
    function Bs(t, e) {
        ...
        const i = ui(t.font, e), s = di(t.padding);
    ...
    class Ns extends Os {
        ...
        generateTickLabels(t) {
            ...
            let i, s, n;
            for(i = 0, s = t.length; i < s; i++)n = t[i], n.label = tt(e.callback, [
                n.value,
                i,
                t
            ], this);
        ...
        calculateLabelRotation() {
            ...
            const h = this._getLabelSizes(), c = h.widest.width, d = h.highest.height, u = Qt(this.chart.width - c, 0, this.maxWidth);
        ...
        fit() {
            ...
            if (o) {
                ...
                if (a ? (t.width = this.maxWidth, t.height = Fs(n) + o) : (t.height = this.maxHeight, t.width = Fs(n) + o), i.display && this.ticks.length) {
                    const { first: e , last: s , widest: n , highest: o  } = this._getLabelSizes(), r = 2 * i.padding, l = Yt(this.labelRotation), h = Math.cos(l), c = Math.sin(l);
                    if (a) {
        ...
        _computeLabelSizes(t87, e61) {
            const { ctx: i48 , _longestTextCache: s35  } = this, n24 = [], o = [];
            let a, r, l, h, c, d, u, f, g, p, m, b = 0, x = 0;
            for(a = 0; a < e61; ++a){
                if (h = t87[a].label, c = this._resolveTickFontOptions(a), i48.font = d = c.string, u = s35[d] = s35[d] || {
                    data: {},
                    gc: []
                }, f = c.lineHeight, g = p = 0, U(h) || X(h)) {
                    if (X(h)) for(r = 0, l = h.length; r < l; ++r)m = h[r], U(m) || X(m) || (g = me(i48, u.data, u.gc, g, m), p += f);
                } else g = me(i48, u.data, u.gc, g, h), p = f;
                n24.push(g), o.push(p), b = Math.max(g, b), x = Math.max(p, x);
            }
            !function(t88, e) {
                et(t88, (t)=>{
            ...
            const _ = n24.indexOf(b), y = o.indexOf(x), v = (t)=>({
                    width: n24[t] || 0,
                    height: o[t] || 0
                });
            return {
        ...
        getContext(t89) {
            const e62 = this.ticks || [];
            if (t89 >= 0 && t89 < e62.length) {
                const i49 = e62[t89];
                return i49.$context || (i49.$context = function(t, e, i) {
                    return pi(t, {
                        tick: i,
                        index: e,
                        type: "tick"
                    });
                }(this.getContext(), t89, i49));
            }
        ...
        _tickSize() {
            const t = this.options.ticks, e = Yt(this.labelRotation), i = Math.abs(Math.cos(e)), s = Math.abs(Math.sin(e)), n = this._getLabelSizes(), o = t.autoSkipPadding || 0, a = n ? n.widest.width + o : 0, r = n ? n.highest.height + o : 0;
        ...
        _computeGridLineItems(t90) {
            const e = this.axis, i = this.chart, s = this.options, { grid: n , position: o  } = s, a = n.offset, r = this.isHorizontal(), l = this.ticks.length + (a ? 1 : 0), h = Fs(n), c = [], d = n.setContext(this.getContext()), u = d.drawBorder ? d.borderWidth : 0, f = u / 2, g = function(t) {
                return xe(i, t, u);
            };
            let p, m, b, x, _, y, v, w, M, k, S, P;
            if ("top" === o) p = g(this.bottom), y = this.bottom - h, w = p - f, k = g(t90.top) + f, P = t90.bottom;
            else if ("bottom" === o) p = g(this.top), k = t90.top, P = g(t90.bottom) - f, y = p + f, w = this.top + h;
            else if ("left" === o) p = g(this.right), _ = this.right - h, v = p - f, M = g(t90.left) + f, S = t90.right;
            else if ("right" === o) p = g(this.left), M = t90.left, S = g(t90.right) - f, _ = p + f, v = this.left + h;
            else if ("x" === e) {
                if ("center" === o) p = g((t90.top + t90.bottom) / 2 + .5);
                else if (q(o)) {
                    const t = Object.keys(o)[0], e = o[t];
                    p = g(this.chart.scales[t].getPixelForValue(e));
                }
                k = t90.top, P = t90.bottom, y = p + f, w = y + h;
            } else if ("y" === e) {
                if ("center" === o) p = g((t90.left + t90.right) / 2);
                else if (q(o)) {
                    const t = Object.keys(o)[0], e = o[t];
                    p = g(this.chart.scales[t].getPixelForValue(e));
                }
                _ = p - f, v = _ - h, M = t90.left, S = t90.right;
            }
            const D = Z(s.ticks.maxTicksLimit, l), C = Math.max(1, Math.ceil(l / D));
            for(m = 0; m < l; m += C){
                const t = n.setContext(this.getContext(m)), e = t.lineWidth, s = t.color, o = n.borderDash || [], l = t.borderDashOffset, h = t.tickWidth, d = t.tickColor, u = t.tickBorderDash || [], f = t.tickBorderDashOffset;
        ...
        _computeLabelItems(t) {
            const e = this.axis, i = this.options, { position: s , ticks: n  } = i, o = this.isHorizontal(), a = this.ticks, { align: r , crossAlign: l , padding: h , mirror: c  } = n, d = Fs(i.grid), u = d + h, f = c ? -h : u, g = -Yt(this.labelRotation), p = [];
            ...
            for(m = 0, b = a.length; m < b; ++m){
                ...
                if (o ? (y = M, "inner" === w && (u = m === b - 1 ? this.options.reverse ? "left" : "right" : 0 === m ? this.options.reverse ? "right" : "left" : "center"), D = "top" === s ? "near" === l || 0 !== g ? -P * S + S / 2 : "center" === l ? -O.highest.height / 2 - e * S + S : -O.highest.height + S / 2 : "near" === l || 0 !== g ? S / 2 : "center" === l ? O.highest.height / 2 - e * S : O.highest.height - P * S, c && (D *= -1)) : (v = M, D = (1 - P) * S / 2), t.showLabelBackdrop) {
                    const e = di(t.backdropPadding), i = O.heights[m], s = O.widths[m];
        ...
        getLineWidthForValue(t) {
            const e63 = this.options.grid;
            if (!this._isVisible() || !e63.display) return 0;
            const i = this.ticks.findIndex((e)=>e.value === t);
            if (i >= 0) return e63.setContext(this.getContext(i)).lineWidth;
            return 0;
        }
        drawGrid(t91) {
            const e64 = this.options.grid, i = this.ctx, s36 = this._gridLineItems || (this._gridLineItems = this._computeGridLineItems(t91));
            let n, o;
            const a = (t, e, s)=>{
            ...
            if (e64.display) for(n = 0, o = s36.length; n < o; ++n){
                const t = s36[n];
                e64.drawOnChartArea && a({
                    x: t.x1,
                    y: t.y1
                }, {
                    x: t.x2,
        ...
        drawTitle() {
            const { ctx: t92 , options: { position: e65 , title: i51 , reverse: s37  }  } = this;
            if (!i51.display) return;
            const o17 = ui(i51.font), a13 = di(i51.padding), r11 = i51.align;
            let l7 = o17.lineHeight / 2;
            "bottom" === e65 || "center" === e65 || q(e65) ? (l7 += a13.bottom, X(i51.text) && (l7 += o17.lineHeight * (i51.text.length - 1))) : l7 += a13.top;
            const { titleX: h4 , titleY: c3 , maxWidth: d3 , rotation: u3  } = function(t, e, i, s) {
            ...
            Pe(t92, i51.text, 0, 0, o17, {
                color: i51.color,
                maxWidth: d3,
                rotation: u3,
                textAlign: Vs(r11, e65, s37),
                textBaseline: "middle",
                translation: [
                    h4,
                    c3
        ...
        _layers() {
            const t93 = this.options, e = t93.ticks && t93.ticks.z || 0, i = Z(t93.grid && t93.grid.z, -1);
    ...
    class Ws {
        ...
        register(t94) {
            const e66 = Object.getPrototypeOf(t94);
            let i52;
            (function(t) {
                return "id" in t && "defaults" in t;
            })(e66) && (i52 = this.register(e66));
            const s38 = this.items, n25 = t94.id, o18 = this.scope + "." + n25;
            if (!n25) throw new Error("class does not have id: " + t94);
            return n25 in s38 || (s38[n25] = t94, function(t95, e67, i53) {
                const s39 = at(Object.create(null), [
                    i53 ? yt.get(i53) : {},
                    yt.get(e67),
                    t95.defaults
                ]);
                yt.set(e67, s39), t95.defaultRoutes && function(t, e) {
                ...
                }(e67, t95.defaultRoutes);
                t95.descriptors && yt.describe(e67, t95.descriptors);
            }(t94, o18, i52), this.override && yt.override(t94.id, t94.overrides)), o18;
        }
        get(t) {
            return this.items[t];
        }
    ...
    var Hs = new class {
        constructor(){
            this.controllers = new Ws(Cs, "datasets", !0), this.elements = new Ws(Os, "elements"), this.plugins = new Ws(Object, "plugins"), this.scales = new Ws(Ns, "scales"), this._typedRegistries = [
                this.controllers,
                this.scales,
                this.elements
            ];
        ...
        _each(t, e68, i) {
            [
                ...
                const s40 = i || this._getRegistryForType(e69);
                i || s40.isForType(e69) || s40 === this.plugins && e69.id ? this._exec(t, s40, e69) : et(e69, (e)=>{
    ...
    class js {
        ...
        _createDescriptors(t98, e70) {
            const i54 = t98 && t98.config, s41 = Z(i54.options && i54.options.plugins, {}), n26 = function(t) {
                const e = [], i = Object.keys(Hs.plugins.items);
                for(let t96 = 0; t96 < i.length; t96++)e.push(Hs.getPlugin(i[t96]));
                const s = t.plugins || [];
                for(let t97 = 0; t97 < s.length; t97++){
                    const i = s[t97];
                    -1 === e.indexOf(i) && e.push(i);
                }
                return e;
            }(i54);
            return !1 !== s41 || e70 ? function(t, e, i, s) {
                const n = [], o = t.getContext();
                for(let a = 0; a < e.length; a++){
                    const r = e[a], l = $s(i[r.id], s);
                    null !== l && n.push({
                        plugin: r,
        ...
        _notifyStateChanges(t99) {
            const e71 = this._oldCache || [], i = this._cache, s = (t100, e72)=>t100.filter((t)=>!e72.some((e)=>t.plugin.id === e.plugin.id));
            this._notify(s(e71, i), t99, "stop"), this._notify(s(i, e71), t99, "start");
        }
    }
    function $s(t, e) {
    ...
    function qs(t101) {
        const e73 = t101.options || (t101.options = {});
        e73.plugins = Z(e73.plugins, {}), e73.scales = function(t102, e74) {
            const i55 = mt[t102.type] || {
                scales: {}
            }, s = e74.scales || {}, n27 = Us(t102.type, e74), o = Object.create(null), a = Object.create(null);
            return Object.keys(s).forEach((t103)=>{
                const e75 = s[t103];
                if (!q(e75)) return console.error(`Invalid scale configuration for scale: ${t103}`);
                if (e75._proxy) return console.warn(`Ignoring resolver passed as options for scale: ${t103}`);
                const r = Xs(t103, e75), l = function(t, e) {
                    return t === e ? "_index_" : "_value_";
                }(r, n27), h = i55.scales || {};
                o[r] = o[r] || t103, a[t103] = rt(Object.create(null), [
                    {
                        axis: r
                    },
                    e75,
            ...
            }), t102.data.datasets.forEach((i56)=>{
                const n28 = i56.type || t102.type, r = i56.indexAxis || Us(n28, e74), l = (mt[n28] || {}).scales || {};
                Object.keys(l).forEach((t104)=>{
                    const e76 = function(t, e) {
                        let i = t;
                        return "_index_" === t ? i = e : "_value_" === t && (i = "x" === e ? "y" : "x"), i;
                    }(t104, r), n = i56[e76 + "AxisID"] || o[e76] || e76;
    ...
    class tn {
        constructor(t105){
            ...
            }(t105), this._scopeCache = new Map, this._resolverCache = new Map;
        }
        get platform() {
        ...
        getOptionScopes(t106, e77, i) {
            const { options: s , type: n  } = this, o = this._cachedScopes(t106, i), a = o.get(e77);
            if (a) return a;
            const r = new Set;
            e77.forEach((e78)=>{
                t106 && (r.add(t106), e78.forEach((e)=>Qs(r, t106, e))), e78.forEach((t)=>Qs(r, s, t)), e78.forEach((t)=>Qs(r, mt[n] || {}, t)), e78.forEach((t)=>Qs(r, yt, t)), e78.forEach((t)=>Qs(r, bt, t));
            });
            const l = Array.from(r);
            return 0 === l.length && l.push(Object.create(null)), Zs.has(e77) && o.set(e77, l), l;
        }
        chartOptionScopes() {
        ...
        resolveNamedOptions(t108, e79, i57, s42 = [
            ""
        ]) {
            const n29 = {
                $shared: !0
            }, { resolver: o19 , subPrefixes: a14  } = en(this._resolverCache, t108, s42);
            let r = o19;
            if (function(t, e) {
                ...
                n29.$shared = !1;
                r = Ae(o19, i57 = ft(i57) ? i57() : i57, this.createResolver(t108, i57, a14));
            }
            for (const t107 of e79)n29[t107] = r[t107];
            return n29;
        }
    ...
    function en(t109, e, i) {
        let s = t109.get(e);
        s || (s = new Map, t109.set(e, s));
        const n = i.join();
        let o = s.get(n);
        if (!o) o = {
            resolver: Oe(e, i),
    ...
    function rn(t) {
        ...
        e.notifyPlugins("afterRender"), tt(i && i.onComplete, [
            t
        ], e);
    }
    function ln(t) {
    ...
    class fn {
        constructor(t111, e){
            const s = this.config = new tn(e), n = hn(t111), o = dn(n);
            ...
            const l = this.platform.acquireContext(n, r.aspectRatio), h = l && l.canvas, c = h && h.height, d = h && h.width;
            this.id = Y(), this.ctx = l, this.canvas = h, this.width = d, this.height = c, this._options = r, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._responsiveListeners = void 0, this._sortedMetasets = [], this.scales = {}, this._plugins = new js, this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = i1((t)=>this.update(t), r.resizeDelay || 0), this._dataChanges = [], cn[this.id] = this, l && h ? (a1.listen(this, "complete", rn), a1.listen(this, "progress", ln), this._initialize(), this.attached && this.update()) : console.error("Failed to create chart: can't acquire context from the given item");
        }
        get aspectRatio() {
        ...
        stop() {
            return a1.stop(this), this;
        }
        resize(t, e) {
            a1.running(this) ? this._resizeBeforeDraw = {
                width: t,
                height: e
            } : this._resize(t, e);
        }
        ...
        buildOrUpdateScales() {
            const t112 = this.options, e80 = t112.scales, i58 = this.scales, s43 = Object.keys(i58).reduce((t, e)=>(t[e] = !1, t), {});
            let n30 = [];
            e80 && (n30 = n30.concat(Object.keys(e80).map((t)=>{
                const i = e80[t], s = Xs(t, i), n = "r" === s, o = "x" === s;
                return {
                    options: i,
                ...
                const n = e.options, o = n.id, a = Xs(o, n), r = Z(n.type, e.dtype);
                void 0 !== n.position && on(n.position, a) === on(e.dposition) || (n.position = e.dposition), s43[o] = !0;
                let l = null;
                if (o in i58 && i58[o].type === r) l = i58[o];
                else l = new (Hs.getScale(r))({
                    id: o,
                    type: r,
                    ctx: this.ctx,
                    chart: this
        ...
        _updateMetasets() {
            const t113 = this._metasets, e81 = this.data.datasets.length, i = t113.length;
            if (t113.sort((t, e)=>t.index - e.index), i > e81) {
                for(let t = e81; t < i; ++t)this._destroyDatasetMeta(t);
                t113.splice(e81, i - e81);
            }
            this._sortedMetasets = t113.slice(0).sort(an("order", "index"));
        }
        _removeUnreferencedMetasets() {
            const { _metasets: t114 , data: { datasets: e82  }  } = this;
            t114.length > e82.length && delete this._stacks, t114.forEach((t, i)=>{
                0 === e82.filter((e)=>e === t._dataset).length && this._destroyDatasetMeta(i);
            });
        }
        ...
        update(t116) {
            ...
            let o = 0;
            for(let t115 = 0, e83 = this.data.datasets.length; t115 < e83; t115++){
                const { controller: e  } = this.getDatasetMeta(t115), i = !s && -1 === n.indexOf(e);
                e.buildOrUpdateElements(i), o = Math.max(+e.getMaxOverflow(), o);
            }
            o = this._minPadding = i.layout.autoPadding ? o : 0, this._updateLayout(o), s || et(n, (t)=>{
                t.reset();
            }), this._updateDatasets(t116), this.notifyPlugins("afterUpdate", {
                mode: t116
        ...
        _getUniformDataChanges() {
            const t118 = this._dataChanges;
            if (!t118 || !t118.length) return;
            this._dataChanges = [];
            const e84 = this.data.datasets.length, i = (e85)=>new Set(t118.filter((t)=>t[0] === e85).map((t, e)=>e + "," + t.splice(1).join(","))), s = i(0);
            for(let t117 = 1; t117 < e84; t117++)if (!gt(s, i(t117))) return;
        ...
        _updateLayout(t119) {
            ...
            Xi.update(this, this.width, this.height, t119);
            const e86 = this.chartArea, i = e86.width <= 0 || e86.height <= 0;
        ...
        _updateDatasets(t) {
            if (!1 !== this.notifyPlugins("beforeDatasetsUpdate", {
                ...
                for(let t120 = 0, e = this.data.datasets.length; t120 < e; ++t120)this.getDatasetMeta(t120).controller.configure();
                for(let e87 = 0, i = this.data.datasets.length; e87 < i; ++e87)this._updateDataset(e87, ft(t) ? t({
                    datasetIndex: e87
                }) : t);
        ...
        render() {
            !1 !== this.notifyPlugins("beforeRender", {
                cancelable: !0
            }) && (a1.has(this) ? this.attached && !a1.running(this) && a1.start(this) : (this.draw(), rn({
                chart: this
            })));
        }
        draw() {
        ...
        getDatasetMeta(t121) {
            const e = this.data.datasets[t121], i = this._metasets;
        ...
        _updateVisibility(t, e88, i) {
            const s = i ? "show" : "hide", n = this.getDatasetMeta(t), o = n.controller._resolveAnimations(void 0, s);
            ut(e88) ? (n.data[e88].hidden = !i, this.update()) : (this.setDatasetVisibility(t, i), o.update(n, {
                visible: i
        ...
        _stop() {
            let t, e;
            for(this.stop(), a1.remove(this), t = 0, e = this.data.datasets.length; t < e; ++t)this._destroyDatasetMeta(t);
        }
        destroy() {
        ...
        bindUserEvents() {
            const t122 = this._listeners, e89 = this.platform, i59 = (i, s)=>{
                e89.addEventListener(this, i, s), t122[i] = s;
            }, s44 = (t, e, i)=>{
                t.offsetX = e, t.offsetY = i, this._eventHandler(t);
            };
            et(this.options.events, (t)=>i59(t, s44));
        }
        bindResponsiveEvents() {
            this._responsiveListeners || (this._responsiveListeners = {});
            const t123 = this._responsiveListeners, e90 = this.platform, i60 = (i, s)=>{
                e90.addEventListener(this, i, s), t123[i] = s;
            }, s45 = (i, s)=>{
                t123[i] && (e90.removeEventListener(this, i, s), delete t123[i]);
            }, n = (t, e)=>{
                this.canvas && this.resize(t, e);
            };
            let o;
            const a = ()=>{
                s45("attach", a), this.attached = !0, this.resize(), i60("resize", n), i60("detach", o);
            };
            o = ()=>{
                this.attached = !1, s45("resize", n), this._stop(), this._resize(0, 0), i60("attach", a);
            }, e90.isAttached(this.canvas) ? a() : o();
        }
        unbindEvents() {
        ...
        setActiveElements(t124) {
            const e91 = this._active || [], i61 = t124.map(({ datasetIndex: t , index: e  })=>{
                const i = this.getDatasetMeta(t);
            ...
            !it(i61, e91) && (this._active = i61, this._lastEvent = null, this._updateHoverStyles(i61, e91));
        }
        notifyPlugins(t, e, i) {
            return this._plugins.notify(this, t, e, i);
        }
        _updateHoverStyles(t125, e92, i) {
            const s = this.options.hover, n = (t126, e93)=>t126.filter((t)=>!e93.some((e)=>t.datasetIndex === e.datasetIndex && t.index === e.index)), o = n(e92, t125), a = i ? t125 : n(t125, e92);
        ...
        _eventHandler(t, e94) {
            ...
            const n = this._handleEvent(t, e94, i.inChartArea);
            return i.cancelable = !1, this.notifyPlugins("afterEvent", i, s), (n || i.changed) && this.render(), this;
        }
        _handleEvent(t127, e95, i62) {
            const { _active: s46 = [] , options: n  } = this, o = e95, a = this._getActiveElements(t127, s46, i62, o), r = pt(t127), l = function(t, e, i, s) {
                return i && "mouseout" !== t.type ? s ? e : t : null;
            }(t127, this._lastEvent, i62, r);
            i62 && (this._lastEvent = null, tt(n.onHover, [
                t127,
                a,
                this
            ], this), r && tt(n.onClick, [
            ...
            const h = !it(a, s46);
            return (h || e95) && (this._active = a, this._updateHoverStyles(a, s46, e95)), this._lastEvent = l, h;
        }
    ...
    const gn = ()=>et(fn.instances, (t)=>t._plugins.invalidate()), pn = !0;
    function mn() {
    ...
    function _n(t128) {
        const e96 = t128.iScale, i63 = function(t129, e98) {
            if (!t129._cache.$bar) {
                const i = t129.getMatchingVisibleMetas(e98);
                let s = [];
                for(let e97 = 0, n = i.length; e97 < n; e97++)s = s.concat(i[e97].controller.getAllParsedValues(t129));
                t129._cache.$bar = Ct(s.sort((t, e)=>t - e));
            }
            return t129._cache.$bar;
        }(e96, t128.type);
        let s47, n31, o, a, r = e96._length;
        const l = ()=>{
            32767 !== o && -32768 !== o && (ut(a) && (r = Math.min(r, Math.abs(o - a) || r)), a = o);
        };
        for(s47 = 0, n31 = i63.length; s47 < n31; ++s47)o = e96.getPixelForValue(i63[s47]), l();
        for(a = void 0, s47 = 0, n31 = e96.ticks.length; s47 < n31; ++s47)o = e96.getPixelForTick(s47), l();
        return r;
    }
    function yn(t130, e99, i64, s48) {
        return X(t130) ? function(t, e, i, s) {
        ...
        }(t130, e99, i64, s48) : e99[i64.axis] = i64.parse(t130, s48), e99;
    }
    function vn(t, e, i, s) {
    ...
    function Mn(t131, e100, i65, s49) {
        let n32 = e100.borderSkipped;
        const o20 = {};
        if (!n32) return void (t131.borderSkipped = o20);
        ...
        "middle" === n32 && i65 && (t131.enableBorderRadius = !0, (i65._top || 0) === s49 ? n32 = h : (i65._bottom || 0) === s49 ? n32 = c : (o20[kn(c, a, r, l)] = !0, n32 = h)), o20[kn(n32, a, r, l)] = !0, t131.borderSkipped = o20;
    }
    function kn(t, e, i, s) {
        var n, o, a;
    ...
    class Dn extends Cs {
        ...
        getLabelAndValue(t) {
            const e = this._cachedMeta, { iScale: i , vScale: s  } = e, n = this.getParsed(t), o = n._custom, a = wn(o) ? "[" + o.start + ", " + o.end + "]" : "" + s.getLabelForValue(n[s.axis]);
            return {
        ...
        updateElements(t, e, i, s) {
            const n = "reset" === s, { index: o , _cachedMeta: { vScale: a  }  } = this, r = a.getBasePixel(), l = a.isHorizontal(), h = this._getRuler(), c = this.resolveDataElementOptions(e, s), d = this.getSharedOptions(c), u = this.includeOptions(s, d);
            this.updateSharedOptions(d, s, c);
            for(let c4 = e; c4 < e + i; c4++){
                const e = this.getParsed(c4), i = n || U(e[a.axis]) ? {
                    base: r,
                    head: r
                } : this._calculateBarValuePixels(c4), f = this._calculateBarIndexPixels(c4, h), g = (e._stacks || {})[a.axis], p = {
                    horizontal: l,
                    base: i.base,
                ...
                u && (p.options = d || this.resolveDataElementOptions(c4, t[c4].active ? "active" : s));
                const m = p.options || t[c4].options;
                Mn(p, m, g, o), Pn(p, m, h.ratio), this.updateElement(t[c4], c4, p, s);
            }
        }
        _getStacks(t, e) {
        ...
        _calculateBarValuePixels(t133) {
            const { _cachedMeta: { vScale: e101 , _stacked: i  } , options: { base: s , minBarLength: n  }  } = this, o = s || 0, a = this.getParsed(t133), r = a._custom, l = wn(r);
            let h, c, d = a[e101.axis], u = 0, f = i ? this.applyStack(e101, a, i) : d;
            f !== d && (u = f - d, f = d), l && (d = r.barStart, f = r.barEnd - r.barStart, 0 !== d && Bt(d) !== Bt(r.barEnd) && (u = 0), u += d);
            const g = U(s) || l ? u : s;
            let p = e101.getPixelForValue(g);
            if (h = this.chart.getDataVisibility(t133) ? e101.getPixelForValue(u + f) : p, c = h - p, Math.abs(c) < n) {
                c = function(t, e, i) {
                    return 0 !== t ? Bt(t) : (e.isHorizontal() ? 1 : -1) * (e.min >= i ? 1 : -1);
                }(c, e101, o) * n, d === o && (p -= c / 2);
                const t132 = e101.getPixelForDecimal(0), i66 = e101.getPixelForDecimal(1), s = Math.min(t132, i66), a = Math.max(t132, i66);
                p = Math.max(Math.min(p, a), s), h = p + c;
            }
            if (p === e101.getPixelForValue(o)) {
                const t = Bt(c) * e101.getLineWidthForValue(o) / 2;
                p += t, c -= t;
            }
            return {
                size: c,
        ...
        _calculateBarIndexPixels(t134, e102) {
            const i68 = e102.scale, s50 = this.options, n33 = s50.skipNull, o21 = Z(s50.maxBarThickness, 1 / 0);
            let a15, r12;
            if (e102.grouped) {
                const i67 = n33 ? this._getStackCount(t134) : e102.stackCount, l8 = "flex" === s50.barThickness ? function(t, e, i, s) {
                ...
                }(t134, e102, s50, i67) : function(t, e, i, s) {
                ...
                }(t134, e102, s50, i67), h5 = this._getStackIndex(this.index, this._cachedMeta.stack, n33 ? t134 : void 0);
                a15 = l8.start + l8.chunk * h5 + l8.chunk / 2, r12 = Math.min(o21, l8.chunk * l8.ratio);
            } else a15 = i68.getPixelForValue(this.getParsed(t134)[i68.axis], t134), r12 = Math.min(o21, e102.min * e102.ratio);
            return {
                base: a15 - r12 / 2,
                head: a15 + r12 / 2,
                center: a15,
    ...
    class Cn extends Cs {
        ...
        parsePrimitiveData(t, e, i, s) {
            ...
            for(let t135 = 0; t135 < n.length; t135++)n[t135]._custom = this.resolveDataElementOptions(t135 + i).radius;
            return n;
        }
        parseArrayData(t, e, i, s) {
            const n = super.parseArrayData(t, e, i, s);
            for(let t136 = 0; t136 < n.length; t136++){
                const s = e[i + t136];
                n[t136]._custom = Z(s[2], this.resolveDataElementOptions(t136 + i).radius);
            }
            return n;
        }
        parseObjectData(t, e, i, s) {
            const n = super.parseObjectData(t, e, i, s);
            for(let t137 = 0; t137 < n.length; t137++){
                const s = e[i + t137];
                n[t137]._custom = Z(s && s.r && +s.r, this.resolveDataElementOptions(t137 + i).radius);
            }
            return n;
        }
        getMaxOverflow() {
        ...
        updateElements(t, e, i, s) {
            ...
            for(let r13 = e; r13 < e + i; r13++){
                const e = t[r13], i = !n && this.getParsed(r13), l = {}, u = l[c] = n ? o.getPixelForDecimal(.5) : o.getPixelForValue(i[c]), f = l[d] = n ? a.getBasePixel() : a.getPixelForValue(i[d]);
                l.skip = isNaN(u) || isNaN(f), h && (l.options = this.resolveDataElementOptions(r13, e.active ? "active" : s), n && (l.options.radius = 0)), this.updateElement(e, r13, l, s);
            }
    ...
    class On extends Cs {
        ...
        parse(t138, e103) {
            ...
            if (!1 === this._parsing) s._parsed = i;
                ...
                for(n = t138, o = t138 + e103; n < o; ++n)s._parsed[n] = a(n);
            }
        }
        _getRotation() {
        ...
        update(t139) {
            const e104 = this.chart, { chartArea: i69  } = e104, s51 = this._cachedMeta, n34 = s51.data, o22 = this.getMaxBorderWidth() + this.getMaxOffset(n34) + this.options.spacing, a16 = Math.max((Math.min(i69.width, i69.height) - o22) / 2, 0), r14 = Math.min(J(this.options.cutout, a16), 1), l10 = this._getRingWeight(this.index), { circumference: h7 , rotation: c5  } = this._getRotationExtents(), { ratioX: d4 , ratioY: u4 , offsetX: f3 , offsetY: g2  } = function(t140, e105, i) {
                let s52 = 1, n = 1, o = 0, a = 0;
                if (e105 < At) {
                    const r = t140, l = r + e105, h = Math.cos(r), c = Math.sin(r), d = Math.cos(l), u = Math.sin(l), f = (t, e, s)=>Jt(t, r, l, !0) ? 1 : Math.max(e, e * i, s, s * i), g = (t, e, s)=>Jt(t, r, l, !0) ? -1 : Math.min(e, e * i, s, s * i), p = f(0, h, d), m = f(Et, c, u), b = g(Ot, h, d), x = g(Ot + Et, c, u);
                    s52 = (p - b) / 2, n = (m - x) / 2, o = -(p + b) / 2, a = -(m + x) / 2;
                }
                return {
                    ratioX: s52,
                    ratioY: n,
            ...
            }(c5, h7, r14), p2 = (i69.width - o22) / d4, m2 = (i69.height - o22) / u4, b2 = Math.max(Math.min(p2, m2) / 2, 0), x2 = Q(this.options.radius, b2), _ = (x2 - Math.max(x2 * r14, 0)) / this._getVisibleDatasetWeightTotal();
            this.offsetX = f3 * x2, this.offsetY = g2 * x2, s51.total = this.calculateTotal(), this.outerRadius = x2 - _ * this._getRingWeightOffset(this.index), this.innerRadius = Math.max(this.outerRadius - _ * l10, 0), this.updateElements(n34, 0, n34.length, t139);
        }
        _circumference(t, e) {
        ...
        getLabelAndValue(t) {
            const e = this._cachedMeta, i = this.chart, s = i.data.labels || [], n = ni(e._parsed[t], i.options.locale);
            return {
                label: s[t] || "",
                value: n
            };
        ...
        plugins: {
            legend: {
                labels: {
                    generateLabels (t) {
                        const e106 = t.data;
                        if (e106.labels.length && e106.datasets.length) {
                            const { labels: { pointStyle: i  }  } = t.legend.options;
                            return e106.labels.map((e, s)=>{
    ...
    class An extends Cs {
        ...
        update(t141) {
            const e107 = this._cachedMeta, { dataset: i70 , data: s53 = [] , _dataset: n35  } = e107, o23 = this.chart._animationsDisabled;
            let { start: a17 , count: r15  } = function(t, e, i) {
                const s = e.length;
                let n = 0, o = s;
                if (t._sorted) {
            ...
            this._drawStart = a17, this._drawCount = r15, function(t) {
            ...
            }(e107) && (a17 = 0, r15 = s53.length), i70._chart = this.chart, i70._datasetIndex = this.index, i70._decimated = !!n35._decimated, i70.points = s53;
            const l11 = this.resolveDatasetElementOptions(t141);
            this.options.showLine || (l11.borderWidth = 0), l11.segment = this.options.segment, this.updateElement(i70, void 0, {
                animated: !o23,
                options: l11
            }, t141), this.updateElements(s53, a17, r15, t141);
        }
        updateElements(t, e, i, s) {
            const n = "reset" === s, { iScale: o , vScale: a , _stacked: r , _dataset: l  } = this._cachedMeta, h = this.resolveDataElementOptions(e, s), c = this.getSharedOptions(h), d = this.includeOptions(s, c), u = o.axis, f = a.axis, { spanGaps: g , segment: p  } = this.options, m = Wt(g) ? g : Number.POSITIVE_INFINITY, b = this.chart._animationsDisabled || n || "none" === s;
            let x = e > 0 && this.getParsed(e - 1);
            for(let h8 = e; h8 < e + i; ++h8){
                const e = t[h8], i = this.getParsed(h8), g = b ? e : {}, _ = U(i[f]), y = g[u] = o.getPixelForValue(i[u], h8), v = g[f] = n || _ ? a.getBasePixel() : a.getPixelForValue(r ? this.applyStack(a, i, r) : i[f], h8);
                g.skip = isNaN(y) || isNaN(v) || _, g.stop = h8 > 0 && Math.abs(i[u] - x[u]) > m, p && (g.parsed = i, g.raw = l.data[h8]), d && (g.options = c || this.resolveDataElementOptions(h8, e.active ? "active" : s)), b || this.updateElement(e, h8, g, s), x = i;
            }
    ...
    class Tn extends Cs {
        ...
        getLabelAndValue(t) {
            const e = this._cachedMeta, i = this.chart, s = i.data.labels || [], n = ni(e._parsed[t].r, i.options.locale);
            return {
                label: s[t] || "",
                value: n
            };
        ...
        updateElements(t, e, i, s) {
            const n = "reset" === s, o = this.chart, a = o.options.animation, r = this._cachedMeta.rScale, l = r.xCenter, h = r.yCenter, c = r.getIndexAngle(0) - .5 * Ot;
            let d, u = c;
        ...
        plugins: {
            legend: {
                labels: {
                    generateLabels (t) {
                        const e108 = t.data;
                        if (e108.labels.length && e108.datasets.length) {
                            const { labels: { pointStyle: i  }  } = t.legend.options;
                            return e108.labels.map((e, s)=>{
                                const n = t.getDatasetMeta(0).controller.getStyle(s);
                                return {
                                    text: e,
                                    fillStyle: n.backgroundColor,
    ...
    function Fn(t142, e109, i, s) {
        const n = li(t142.options.borderRadius, [
            "outerStart",
            "outerEnd",
            "innerStart",
            "innerEnd"
        ]);
        const o = (i - e109) / 2, a = Math.min(o, s * e109 / 2), r = (t)=>{
    ...
    function Vn(t, e, i, s, n) {
        ...
        const g = (f - Math.max(.001, f * c - i / Ot) / c) / 2, p = r + g + u, m = n - g - u, { outerStart: b , outerEnd: x , innerStart: _ , innerEnd: y  } = Fn(e, d, c, m - p), v = c - b, w = c - x, M = p + b / v, k = m - x / w, S = d + _, P = d + y, D = p + _ / S, C = m - y / P;
    ...
    function Nn(t143, e110, i71, s54, n36) {
        const { options: o24  } = e110, { borderWidth: a18 , borderJoinStyle: r16  } = o24, l12 = "inner" === o24.borderAlign;
        a18 && (l12 ? (t143.lineWidth = 2 * a18, t143.lineJoin = r16 || "round") : (t143.lineWidth = a18, t143.lineJoin = r16 || "bevel"), e110.fullCircles && function(t, e, i) {
        ...
        }(t143, e110, l12), l12 && zn(t143, e110, n36), Vn(t143, e110, i71, s54, n36), t143.stroke());
    }
    class Wn extends Os {
        constructor(t){
        ...
        inRange(t, e, i) {
            const s = this.getProps([
                ...
                "outerRadius",
                "circumference"
            ], i), d = this.options.spacing / 2, u = Z(c, r - a) >= At || Jt(n, a, r), f = ee(o, l + d, h + d);
            return u && f;
        }
        getCenterPoint(t) {
        ...
        draw(t144) {
            const { options: e111 , circumference: i72  } = this, s55 = (e111.offset || 0) / 2, n37 = (e111.spacing || 0) / 2;
            if (this.pixelMargin = "inner" === e111.borderAlign ? .33 : 0, this.fullCircles = i72 > At ? Math.floor(i72 / At) : 0, 0 === i72 || this.innerRadius < 0 || this.outerRadius < 0) return;
            t144.save();
            let o25 = 0;
            if (s55) {
                o25 = s55 / 2;
                const e = (this.startAngle + this.endAngle) / 2;
                t144.translate(Math.cos(e) * o25, Math.sin(e) * o25), this.circumference >= Ot && (o25 = s55);
            }
            t144.fillStyle = e111.backgroundColor, t144.strokeStyle = e111.borderColor;
            const a19 = function(t, e, i, s) {
                const { fullCircles: n , startAngle: o , circumference: a  } = e;
                let r = e.endAngle;
                if (n) {
                    Vn(t, e, i, s, o + At);
                    for(let e112 = 0; e112 < n; ++e112)t.fill();
                    isNaN(a) || (r = o + a % At, a % At == 0 && (r += At));
                }
                return Vn(t, e, i, s, r), t.fill(), r;
            }(t144, this, o25, n37);
            Nn(t144, this, o25, n37, a19), t144.restore();
        }
    }
    function Hn(t, e, i = e) {
    ...
    function Yn(t145, e, i, s) {
        const { points: n , options: o  } = e, { count: a , start: r , loop: l , ilen: h  } = $n(n, i, s), c = function(t) {
            return t.stepped ? ke : t.tension || "monotone" === t.cubicInterpolationMode ? Se : jn;
        }(o);
        let d, u, f, { move: g = !0 , reverse: p  } = s || {};
        for(d = 0; d <= h; ++d)u = n[(r + (p ? h - d : d)) % a], u.skip || (g ? (t145.moveTo(u.x, u.y), g = !1) : c(t145, f, u, p, o.stepped), f = u);
        return l && (u = n[(r + (p ? h : 0)) % a], c(t145, f, u, p, o.stepped)), !!l;
    }
    function Un(t146, e, i, s) {
        const n = e.points, { count: o , start: a , ilen: r  } = $n(n, i, s), { move: l = !0 , reverse: h  } = s || {};
        let c, d, u, f, g, p, m = 0, b = 0;
        const x = (t)=>(a + (h ? r - t : t)) % o, _ = ()=>{
            f !== g && (t146.lineTo(m, g), t146.lineTo(m, f), t146.lineTo(m, p));
        };
        for(l && (d = n[x(0)], t146.moveTo(d.x, d.y)), c = 0; c <= r; ++c){
            if (d = n[x(c)], d.skip) continue;
            const e = d.x, i = d.y, s = 0 | e;
            s === u ? (i < f ? f = i : i > g && (g = i), m = (b * m + e) / ++b) : (_(), t146.lineTo(e, i), u = s, b = 0, f = g = i), p = i;
        }
        _();
    }
    function Xn(t) {
    ...
    function Kn(t147, e113, i73, s56) {
        qn && !e113.options.segment ? function(t, e, i, s) {
            let n = e._path;
            n || (n = e._path = new Path2D, e.path(n, i, s) && n.closePath()), Hn(t, e.options), t.stroke(n);
        }(t147, e113, i73, s56) : function(t, e, i, s) {
            const { segments: n , options: o  } = e, a = Xn(e);
    ...
    class Gn extends Os {
        ...
        interpolate(t148, e) {
            const i = this.options, s = t148[e], n = this.points, o = wi(this, {
                property: e,
                start: s,
                end: s
            });
        ...
        path(t, e, i) {
            const s = this.segments, n = Xn(this);
            let o = this._loop;
    ...
    function eo(t149) {
        const e114 = Qn(t149), i74 = e114.right - e114.left, s57 = e114.bottom - e114.top, n38 = function(t, e, i) {
            const s = t.options.borderWidth, n = t.borderSkipped, o = hi(s);
            return {
        ...
        }(t149, i74 / 2, s57 / 2), o26 = function(t, e, i) {
            const { enableBorderRadius: s  } = t.getProps([
                "enableBorderRadius"
            ]), n = t.options.borderRadius, o = ci(n), a = Math.min(e, i), r = t.borderSkipped, l = s || q(n);
            return {
        ...
        return {
            ...
            inner: {
                ...
                h: s57 - n38.t - n38.b,
                radius: {
                    topLeft: Math.max(0, o26.topLeft - Math.max(n38.t, n38.l)),
                    topRight: Math.max(0, o26.topRight - Math.max(n38.t, n38.r)),
                    bottomLeft: Math.max(0, o26.bottomLeft - Math.max(n38.b, n38.l)),
                    bottomRight: Math.max(0, o26.bottomRight - Math.max(n38.b, n38.r))
                }
            }
        };
    }
    function io(t, e, i, s) {
        const n = null === e, o = null === i, a = t && !(n && o) && Qn(t, s);
    ...
    class oo extends Os {
        ...
        draw(t) {
            const { inflateAmount: e , options: { borderColor: i , backgroundColor: s  }  } = this, { inner: n , outer: o  } = eo(this), a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? Ce : so;
            var r;
    ...
    var ho = {
        ...
        beforeElementsUpdate: (t151, e115, i75)=>{
            if (!i75.enabled) return void lo(t151);
            const s58 = t151.width;
            t151.data.datasets.forEach((e116, n39)=>{
                const { _data: o27 , indexAxis: a20  } = e116, r17 = t151.getDatasetMeta(n39), l13 = o27 || e116.data;
                if ("y" === fi([
                    a20,
                    t151.options.indexAxis
                ])) return;
                if (!r17.controller.supportsDecimation) return;
                const h9 = t151.scales[r17.xAxisID];
                if ("linear" !== h9.type && "time" !== h9.type) return;
                if (t151.options.parsing) return;
                let { start: c6 , count: d5  } = function(t, e) {
                    const i = e.length;
                    let s, n = 0;
                ...
                if (d5 <= (i75.threshold || 4 * s58)) return void ro(e116);
                let u5;
                switch(U(o27) && (e116._data = l13, delete e116.data, Object.defineProperty(e116, "data", {
                    configurable: !0,
                    enumerable: !0,
                    get: function() {
                    ...
                    case "min-max":
                        ...
                        break;
                    default:
                        throw new Error(`Unsupported decimation algorithm '${i75.algorithm}'`);
                }
                e116._decimated = u5;
            });
        },
    ...
    function go(t152, e117) {
        let i76 = [], s59 = !1;
        return X(t152) ? (s59 = !0, i76 = t152) : i76 = function(t153, e118) {
            const { x: i = null , y: s = null  } = t153 || {}, n = e118.points, o = [];
            return e118.segments.forEach(({ start: t , end: e  })=>{
                e = uo(t, e, n);
                const a = n[t], r = n[e];
                null !== s ? (o.push({
                    x: a.x,
    ...
    function mo(t154, e119, i77) {
        const s60 = function(t) {
        ...
        if (q(s60)) return !isNaN(s60.value) && s60;
        let n = parseFloat(s60);
    ...
    function bo(t, e, i) {
        ...
        for(let n = 0; n < i.length; n++){
            const o = i[n], { first: a , last: r , point: l  } = xo(o, e, "x");
            if (!(!l || a && r)) {
                if (a) s.unshift(l);
    ...
    function xo(t, e, i) {
        ...
        let r = !1, l = !1;
        for(let t155 = 0; t155 < o.length; t155++){
            const e = o[t155], s = a[e.start][i], h = a[e.end][i];
            if (ee(n, s, h)) {
                r = n === s, l = n === h;
                break;
            }
    ...
    function yo(t156) {
        const { chart: e120 , fill: i78 , line: s61  } = t156;
        if (K(i78)) return function(t, e) {
            const i = t.getDatasetMeta(e);
            return i && t.isDatasetVisible(e) ? i.dataset : null;
        }(e120, i78);
        if ("stack" === i78) return function(t159) {
            const { scale: e121 , index: i79 , line: s62  } = t159, n41 = [], o = s62.segments, a = s62.points, r = function(t, e) {
                const i = [], s = t.getMatchingVisibleMetas("line");
                for(let t158 = 0; t158 < s.length; t158++){
                    const n = s[t158];
                    if (n.index === e) break;
            ...
            for(let t157 = 0; t157 < o.length; t157++){
                const e = o[t157];
                for(let t = e.start; t <= e.end; t++)bo(n41, a[t], r);
            }
            return new Gn({
                points: n41,
                options: {}
        ...
        if ("shape" === i78) return !0;
        const n40 = function(t161) {
            if ((t161.scale || {}).getPointPositionForValue) return function(t162) {
                const { scale: e122 , fill: i80  } = t162, s63 = e122.options, n = e122.getLabels().length, o = s63.reverse ? e122.max : e122.min, a = function(t, e, i) {
                    let s;
                    return s = "start" === t ? i : "end" === t ? e.options.reverse ? e.min : e.max : q(t) ? t.value : e.getBaseValue(), s;
                }(i80, e122, o), r = [];
                if (s63.grid.circular) {
                    const t = e122.getPointPositionForValue(0, o);
                    return new _o({
                        x: t.x,
                        y: t.y,
                        radius: e122.getDistanceFromCenterForValue(a)
                    });
                }
                for(let t160 = 0; t160 < n; ++t160)r.push(e122.getPointPositionForValue(t160, a));
                return r;
            }(t161);
            return function(t163) {
                const { scale: e123 = {} , fill: i81  } = t163, s = function(t, e) {
                    let i = null;
                    return "start" === t ? i = e.bottom : "end" === t ? i = e.top : q(t) ? i = e.getPixelForValue(t.value) : e.getBasePixel && (i = e.getBasePixel()), i;
                }(i81, e123);
                if (K(s)) {
                    const t = e123.isHorizontal();
                    return {
                        x: t ? s : null,
                        y: t ? null : s
                    };
        ...
        return n40 instanceof _o ? n40 : go(n40, s61);
    }
    function vo(t164, e124, i82) {
        const s64 = yo(e124), { line: n42 , scale: o28 , axis: a21  } = e124, r18 = n42.options, l14 = r18.fill, h = r18.backgroundColor, { above: c = h , below: d = h  } = l14 || {};
        s64 && n42.points.length && (we(t164, i82), function(t, e) {
    ...
    function wo(t, e, i) {
        ...
        t.beginPath();
        for (const r of s){
            const { start: s , end: l  } = r, h = n[s], c = n[uo(s, l, n)];
    ...
    function Mo(t166, e126) {
        const { line: i83 , target: s65 , property: n43 , color: o29 , scale: a22  } = e126, r19 = function(t, e, i) {
            const s = t.segments, n = t.points, o = e.points, a = [];
            for (const t165 of s){
                let { start: s , end: r  } = t165;
                r = uo(s, r, n);
                const l = co(i, n[s], n[r], t165.loop);
                if (!e.segments) {
                    a.push({
                        source: t165,
                        target: l,
                ...
                const h = wi(e, l);
                for (const e127 of h){
                    const s = co(i, o[e127.start], o[e127.end], e127.loop), r = vi(t165, n, s);
        ...
        for (const { source: e125 , target: l15 , start: h10 , end: c  } of r19){
            const { style: { backgroundColor: r = o29  } = {}  } = e125, d = !0 !== s65;
            t166.save(), t166.fillStyle = r, ko(t166, a22, d && co(n43, h10, c)), t166.beginPath();
            const u = !!i83.pathSegment(t166, e125);
            let f;
            if (d) {
                u ? t166.closePath() : So(t166, s65, c, n43);
                const e = !!s65.pathSegment(t166, l15, {
                    move: u,
                    reverse: !0
                });
                f = u && e, f || So(t166, s65, h10, n43);
            }
            t166.closePath(), t166.fill(f ? "evenodd" : "nonzero"), t166.restore();
        }
    }
    function ko(t, e, i) {
    ...
    var Po = {
        ...
        beforeDraw (t, e, i) {
            ...
            for(let e128 = n.length - 1; e128 >= 0; --e128){
                const i = n[e128].$filler;
        ...
        beforeDatasetsDraw (t, e, i) {
            ...
            for(let e129 = s.length - 1; e129 >= 0; --e129){
                const i = s[e129].$filler;
    ...
    class Co extends Os {
        ...
        buildLabels() {
            ...
            let e130 = tt(t.generateLabels, [
                this.chart
            ], this) || [];
            t.filter && (e130 = e130.filter((e)=>t.filter(e, this.chart.data))), t.sort && (e130 = e130.sort((e, i)=>t.sort(e, i, this.chart.data))), this.options.reverse && e130.reverse(), this.legendItems = e130;
        }
        fit() {
            const { options: t , ctx: e  } = this;
            if (!t.display) return void (this.width = this.height = 0);
            const i = t.labels, s = ui(i.font), n = s.size, o = this._computeTitleHeight(), { boxWidth: a , itemHeight: r  } = Do(i, n);
            let l, h;
        ...
        _fitCols(t168, e, i, s) {
            const { ctx: n , maxHeight: o30 , options: { labels: { padding: a  }  }  } = this, r = this.legendHitBoxes = [], l = this.columnSizes = [], h = o30 - t168;
        ...
        adjustHitBoxes() {
            ...
            const t = this._computeTitleHeight(), { legendHitBoxes: e , options: { align: i , labels: { padding: s  } , rtl: o  }  } = this, a = mi(o, this.left, this.width);
            if (this.isHorizontal()) {
                let o = 0, r = n1(i, this.left + s, this.right - this.lineWidths[o]);
                for (const l of e)o !== l.row && (o = l.row, r = n1(i, this.left + s, this.right - this.lineWidths[o])), l.top += this.top + t + s, l.left = a.leftForLtr(a.x(r), l.width), r += l.width + s;
            } else {
                let o = 0, r = n1(i, this.top + t + s, this.bottom - this.columnSizes[o].height);
                for (const l of e)l.col !== o && (o = l.col, r = n1(i, this.top + t + s, this.bottom - this.columnSizes[o].height)), l.top = r, l.left += this.left + s, l.left = a.leftForLtr(a.x(l.left), l.width), r += l.height + s;
            }
        }
        isHorizontal() {
        ...
        _draw() {
            const { options: t169 , columnSizes: e131 , lineWidths: i84 , ctx: s  } = this, { align: a23 , labels: r20  } = t169, l = yt.color, h = mi(t169.rtl, this.left, this.width), c = ui(r20.font), { color: d , padding: u  } = r20, f = c.size, g = f / 2;
            let p;
            this.drawTitle(), s.textAlign = h.textAlign("left"), s.textBaseline = "middle", s.lineWidth = .5, s.font = c.string;
            const { boxWidth: m , boxHeight: b , itemHeight: x  } = Do(r20, f), _ = this.isHorizontal(), y = this._computeTitleHeight();
            p = _ ? {
                x: n1(a23, this.left + u, this.right - i84[0]),
                y: this.top + u + y,
                line: 0
            } : {
                x: this.left + u,
                y: n1(a23, this.top + y + u, this.bottom - e131[0].height),
                line: 0
            }, bi(this.ctx, t169.textDirection);
            const v = x + u;
            this.legendItems.forEach((w, M)=>{
                s.strokeStyle = w.fontColor || d, s.fillStyle = w.fontColor || d;
                const k = s.measureText(w.text).width, S = h.textAlign(w.textAlign || (w.textAlign = r20.textAlign)), P = m + g + k;
                let D = p.x, C = p.y;
                h.setWidth(this.width), _ ? M > 0 && D + P + u > this.right && (C = p.y += v, p.line++, D = p.x = n1(a23, this.left + u, this.right - i84[p.line])) : M > 0 && C + v > this.bottom && (D = p.x = D + e131[p.line].width + u, p.line++, C = p.y = n1(a23, this.top + y + u, this.bottom - e131[p.line].height));
                !function(t170, e, i) {
                    if (isNaN(m) || m <= 0 || isNaN(b) || b < 0) return;
                    s.save();
                    const n = Z(i.lineWidth, 1);
                    if (s.fillStyle = Z(i.fillStyle, l), s.lineCap = Z(i.lineCap, "butt"), s.lineDashOffset = Z(i.lineDashOffset, 0), s.lineJoin = Z(i.lineJoin, "miter"), s.lineWidth = n, s.strokeStyle = Z(i.strokeStyle, l), s.setLineDash(Z(i.lineDash, [])), r20.usePointStyle) {
                        const o = {
                        ...
                        const o = e + Math.max((f - b) / 2, 0), a = h.leftForLtr(t170, m), r = ci(i.borderRadius);
                    ...
                    s.restore();
                }(h.x(D), C, w), D = o1(S, D + m + g, _ ? D + P : this.right, t169.rtl), function(t, e, i) {
                    Pe(s, i.text, t, e + x / 2, c, {
                        strikethrough: i.hidden,
                        textAlign: h.textAlign(i.textAlign)
                    });
                }(h.x(D), C, w), _ ? p.x += P + u : p.y += v;
            }), xi(this.ctx, t169.textDirection);
        }
        drawTitle() {
            const t171 = this.options, e = t171.title, i = ui(e.font), o = di(e.padding);
            if (!e.display) return;
            const a = mi(t171.rtl, this.left, this.width), r = this.ctx, l = e.position, h = i.size / 2, c = o.top + h;
            let d, u = this.left, f = this.width;
            if (this.isHorizontal()) f = Math.max(...this.lineWidths), d = this.top + c, u = n1(t171.align, u, this.right - f);
            else {
                const e132 = this.columnSizes.reduce((t, e)=>Math.max(t, e.height), 0);
                d = c + n1(t171.align, this.top, this.bottom - e132 - t171.labels.padding - this._computeTitleHeight());
            }
            const g = n1(l, u, u + f);
            r.textAlign = a.textAlign(s1(l)), r.textBaseline = "middle", r.strokeStyle = e.color, r.fillStyle = e.color, r.font = i.string, Pe(r, e.text, g, d, i);
        }
        _computeTitleHeight() {
            const t = this.options.title, e = ui(t.font), i = di(t.padding);
        ...
        handleEvent(t172) {
            const e133 = this.options;
            if (!function(t, e) {
                if (("mousemove" === t || "mouseout" === t) && (e.onHover || e.onLeave)) return !0;
                if (e.onClick && ("click" === t || "mouseup" === t)) return !0;
                return !1;
            }(t172.type, e133)) return;
            const i = this._getLegendItemAt(t172.x, t172.y);
            if ("mousemove" === t172.type || "mouseout" === t172.type) {
                const o = this._hoveredItem, a = (n = i, null !== (s = o) && null !== n && s.datasetIndex === n.datasetIndex && s.index === n.index);
                o && !a && tt(e133.onLeave, [
                    t172,
                    o,
                    this
                ], this), this._hoveredItem = i, i && !a && tt(e133.onHover, [
                    t172,
                    i,
                    this
                ], this);
            } else i && tt(e133.onClick, [
                t172,
                i,
                this
            ], this);
    ...
    var Oo = {
        ...
        defaults: {
            ...
            labels: {
                ...
                padding: 10,
                generateLabels (t173) {
                    const e = t173.data.datasets, { labels: { usePointStyle: i , pointStyle: s , textAlign: n , color: o  }  } = t173.legend.options;
                    return t173._getSortedDatasetMetas().map((t)=>{
                        const a = t.controller.getStyle(i ? 0 : void 0), r = di(a.borderWidth);
                        return {
    ...
    class Ao extends Os {
        ...
        _drawArgs(t) {
            ...
            let l, h, c, d = 0;
            return this.isHorizontal() ? (h = n1(r, i, o), c = e + t, l = o - i) : ("left" === a.position ? (h = i + t, c = n1(r, s, e), d = -0.5 * Ot) : (h = o - t, c = n1(r, e, s), d = .5 * Ot), l = s - e), {
                titleX: h,
                titleY: c,
                maxWidth: l,
                rotation: d
        ...
        draw() {
            ...
            if (!e.display) return;
            const i = ui(e.font), n = i.lineHeight / 2 + this._padding.top, { titleX: o , titleY: a , maxWidth: r , rotation: l  } = this._drawArgs(n);
            Pe(t, e.text, 0, 0, i, {
                color: e.color,
                maxWidth: r,
                rotation: l,
                textAlign: s1(e.align),
                textBaseline: "middle",
                translation: [
                    o,
                    a
    ...
    function Bo(t175, e135) {
        const i = t175.chart.ctx, { body: s , footer: n , title: o  } = t175, { boxWidth: a , boxHeight: r  } = e135, l = ui(e135.bodyFont), h = ui(e135.titleFont), c = ui(e135.footerFont), d = o.length, u = n.length, f = s.length, g = di(e135.padding);
        let p = g.height, m = 0, b = s.reduce((t, e)=>t + e.before.length + e.lines.length + e.after.length, 0);
        if (b += t175.beforeBody.length + t175.afterBody.length, d && (p += d * h.lineHeight + (d - 1) * e135.titleSpacing + e135.titleMarginBottom), b) p += f * (e135.displayColors ? Math.max(r, l.lineHeight) : l.lineHeight) + (b - f) * l.lineHeight + (b - 1) * e135.bodySpacing;
        u && (p += e135.footerMarginTop + u * c.lineHeight + (u - 1) * e135.footerSpacing);
        let x = 0;
        const _ = function(t) {
            m = Math.max(m, i.measureText(t).width + x);
        };
        return i.save(), i.font = h.string, et(t175.title, _), i.font = l.string, et(t175.beforeBody.concat(t175.afterBody), _), x = e135.displayColors ? a + 2 + e135.boxPadding : 0, et(s, (t)=>{
            et(t.before, _), et(t.lines, _), et(t.after, _);
        }), x = 0, i.font = c.string, et(t175.footer, _), i.restore(), m += g.width, {
            width: m,
            height: p
        };
    }
    function Vo(t176, e136, i86, s66) {
        const { x: n44 , width: o31  } = i86, { width: a24 , chartArea: { left: r , right: l  }  } = t176;
        let h = "center";
        return "center" === s66 ? h = n44 <= (r + l) / 2 ? "left" : "right" : n44 <= o31 / 2 ? h = "left" : n44 >= a24 - o31 / 2 && (h = "right"), function(t, e, i, s) {
            const { x: n , width: o  } = s, a = i.caretSize + i.caretPadding;
            return "left" === t && n + o + a > e.width || "right" === t && n - o - a < 0 || void 0;
        }(h, t176, e136, i86) && (h = "center"), h;
    }
    function No(t177, e137, i87) {
        const s67 = i87.yAlign || e137.yAlign || function(t, e) {
            const { y: i , height: s  } = e;
            return i < s / 2 ? "top" : i > t.height - s / 2 ? "bottom" : "center";
        }(t177, i87);
        return {
            xAlign: i87.xAlign || e137.xAlign || Vo(t177, e137, i87, s67),
            yAlign: s67
        };
    }
    function Wo(t178, e138, i88, s68) {
        const { caretSize: n45 , caretPadding: o , cornerRadius: a  } = t178, { xAlign: r , yAlign: l  } = i88, h = n45 + o, { topLeft: c , topRight: d , bottomLeft: u , bottomRight: f  } = ci(a);
        let g = function(t, e) {
            let { x: i , width: s  } = t;
        ...
        return "center" === l ? "left" === r ? g += h : "right" === r && (g -= h) : "left" === r ? g -= Math.max(c, u) + n45 : "right" === r && (g += Math.max(d, f) + n45), {
            x: Qt(g, 0, s68.width - e138.width),
            y: Qt(p, 0, s68.height - e138.height)
        };
    }
    function Ho(t, e, i) {
    ...
    class Yo extends Os {
        ...
        _resolveAnimations() {
            ...
            if (t) return t;
            const e = this.chart, i = this.options.setContext(this.getContext()), s = i.enabled && e.options.animation && i.animations, n = new ms(this.chart, s);
        ...
        getBeforeBody(t, e) {
            return jo(e.callbacks.beforeBody.apply(this, [
                t
            ]));
        }
        getBody(t179, e139) {
            const { callbacks: i  } = e139, s = [];
            return et(t179, (t)=>{
                const e = {
                    before: [],
                    lines: [],
        ...
        getAfterBody(t, e) {
            return jo(e.callbacks.afterBody.apply(this, [
                t
            ]));
        }
        getFooter(t, e) {
        ...
        _createItems(t) {
            const e140 = this._active, i89 = this.chart.data, s69 = [], n46 = [], o = [];
            let a, r, l = [];
            for(a = 0, r = e140.length; a < r; ++a)l.push(Fo(this.chart, e140[a]));
            return t.filter && (l = l.filter((e, s, n)=>t.filter(e, s, n, i89))), t.itemSort && (l = l.sort((e, s)=>t.itemSort(e, s, i89))), et(l, (e)=>{
                const i = $o(t.callbacks, e);
                s69.push(i.labelColor.call(this, e)), n46.push(i.labelPointStyle.call(this, e)), o.push(i.labelTextColor.call(this, e));
            }), this.labelColors = s69, this.labelPointStyles = n46, this.labelTextColors = o, this.dataPoints = l, l;
        }
        update(t, e) {
            ...
            if (s.length) {
                ...
                const e = this._size = Bo(this, i), a = Object.assign({}, t, e), r = No(this.chart, i, a), l = Wo(i, a, r, this.chart);
        ...
        getCaretPosition(t, e, i) {
            const { xAlign: s , yAlign: n  } = this, { caretSize: o , cornerRadius: a  } = i, { topLeft: r , topRight: l , bottomLeft: h , bottomRight: c  } = ci(a), { x: d , y: u  } = t, { width: f , height: g  } = e;
            let p, m, b, x, _, y;
        ...
        _drawColorBox(t180, e, i, s, n) {
            const o = this.labelColors[i], a = this.labelPointStyles[i], { boxHeight: r , boxWidth: l , boxPadding: h  } = n, c = ui(n.bodyFont), d = Ho(this, "left", n), u = s.x(d), f = r < c.lineHeight ? (c.lineHeight - r) / 2 : 0, g = e.y + f;
            if (n.usePointStyle) {
                const e = {
                ...
                t180.strokeStyle = n.multiKeyBackground, t180.fillStyle = n.multiKeyBackground, ye(t180, e, i, h), t180.strokeStyle = o.borderColor, t180.fillStyle = o.backgroundColor, ye(t180, e, i, h);
            } else {
                t180.lineWidth = o.borderWidth || 1, t180.strokeStyle = o.borderColor, t180.setLineDash(o.borderDash || []), t180.lineDashOffset = o.borderDashOffset || 0;
                const e = s.leftForLtr(u, l - h), i = s.leftForLtr(s.xPlus(u, 1), l - h - 2), a = ci(o.borderRadius);
                Object.values(a).some((t)=>0 !== t) ? (t180.beginPath(), t180.fillStyle = n.multiKeyBackground, Ce(t180, {
                    x: e,
                    y: g,
                    w: l,
                    h: r,
                    radius: a
                }), t180.fill(), t180.stroke(), t180.fillStyle = o.backgroundColor, t180.beginPath(), Ce(t180, {
                    x: i,
                    y: g + 1,
                    w: l - 2,
                    h: r - 2,
                    radius: a
                }), t180.fill()) : (t180.fillStyle = n.multiKeyBackground, t180.fillRect(e, g, l, r), t180.strokeRect(e, g, l, r), t180.fillStyle = o.backgroundColor, t180.fillRect(i, g + 1, l - 2, r - 2));
            }
            t180.fillStyle = this.labelTextColors[i];
        }
        drawBody(t, e, i90) {
            const { body: s  } = this, { bodySpacing: n , bodyAlign: o , displayColors: a , boxHeight: r , boxWidth: l , boxPadding: h  } = i90, c = ui(i90.bodyFont);
            let d = c.lineHeight, u = 0;
            const f = mi(i90.rtl, this.x, this.width), g = function(i) {
                e.fillText(i, f.x(t.x + u), t.y + d / 2), t.y += d + n;
            }, p = f.textAlign(o);
            let m, b, x, _, y, v, w;
            for(e.textAlign = o, e.textBaseline = "middle", e.font = c.string, t.x = Ho(this, p, i90), e.fillStyle = i90.bodyColor, et(this.beforeBody, g), u = a && "right" !== p ? "center" === o ? l / 2 + h : l + 2 + h : 0, _ = 0, v = s.length; _ < v; ++_){
                for(m = s[_], b = this.labelTextColors[_], e.fillStyle = b, et(m.before, g), x = m.lines, a && x.length && (this._drawColorBox(e, t, _, f, i90), d = Math.max(c.lineHeight, r)), y = 0, w = x.length; y < w; ++y)g(x[y]), d = c.lineHeight;
                et(m.after, g);
            }
        ...
        drawBackground(t, e, i, s) {
            const { xAlign: n , yAlign: o  } = this, { x: a , y: r  } = t, { width: l , height: h  } = i, { topLeft: c , topRight: d , bottomLeft: u , bottomRight: f  } = ci(s.cornerRadius);
        ...
        _updateAnimationTarget(t) {
            ...
            if (s || n) {
                ...
                if (!i) return;
                const o = this._size = Bo(this, t), a = Object.assign({}, i, this._size), r = No(e, t, a), l = Wo(t, a, r, e);
        ...
        draw(t) {
            ...
            const o = di(e.padding), a = this.title.length || this.beforeBody.length || this.body.length || this.afterBody.length || this.footer.length;
        ...
        setActiveElements(t181, e141) {
            const i91 = this._active, s = t181.map(({ datasetIndex: t , index: e  })=>{
            ...
            }), n = !it(i91, s), o = this._positionChanged(s, e141);
            (n || o) && (this._active = s, this._eventPosition = e141, this._ignoreReplayEvents = !0, this.update(!0));
        }
        handleEvent(t, e, i = !0) {
            if (e && this._ignoreReplayEvents) return !1;
            this._ignoreReplayEvents = !1;
            const s = this.options, n = this._active || [], o = this._getActiveElements(t, n, e, i), a = this._positionChanged(o, t), r = e || !it(o, n) || a;
        ...
        _positionChanged(t, e) {
            const { caretX: i , caretY: s , options: n  } = this, o = Eo[n.position].call(this, t, e);
    ...
    function qo(t182, e142, i92, s70) {
        const n = t182.indexOf(e142);
        if (-1 === n) return ((t, e, i, s)=>("string" == typeof e ? (i = t.push(e) - 1, s.unshift({
                index: i,
                label: e
            })) : isNaN(e) && (i = null), i))(t182, e142, i92, s70);
        return n !== t182.lastIndexOf(e142) ? i92 : n;
    }
    class Ko extends Ns {
        constructor(t){
        ...
        parse(t183, e143) {
            if (U(t183)) return null;
            const i = this.getLabels();
            return ((t, e)=>null === t ? null : Qt(Math.round(t), 0, e))(e143 = isFinite(e143) && i[e143] === t183 ? e143 : qo(i, t183, Z(e143, t183), this._addedLabels), i.length - 1);
        }
        determineDataLimits() {
        ...
        buildTicks() {
            ...
            for(let i93 = t; i93 <= e; i93++)s.push({
                value: i93
            });
            return s;
        }
    ...
    class Zo extends Ns {
        ...
        handleTickRangeOptions() {
            const { beginAtZero: t184  } = this.options, { minDefined: e , maxDefined: i  } = this.getUserBounds();
            ...
            if (s === n) {
                let e = 1;
                (n >= Number.MAX_SAFE_INTEGER || s <= Number.MIN_SAFE_INTEGER) && (e = Math.abs(.05 * n)), a(n + e), t184 || o(s - e);
            }
        ...
        buildTicks() {
            const t185 = this.options, e144 = t185.ticks;
            let i94 = this.getTickLimit();
            i94 = Math.max(2, i94);
            const s71 = function(t, e) {
                const i = [], { bounds: s , step: n , min: o , max: a , precision: r , count: l , maxTicks: h , maxDigits: c , includeBounds: d  } = t, u = n || 1, f = h - 1, { min: g , max: p  } = e, m = !U(o), b = !U(a), x = !U(l), _ = (p - g) / (c + 1);
                ...
                min: t185.min,
                max: t185.max,
                precision: e144.precision,
                step: e144.stepSize,
                count: e144.count,
                maxDigits: this._maxDigits(),
                horizontal: this.isHorizontal(),
                minRotation: e144.minRotation || 0,
                includeBounds: !1 !== e144.includeBounds
            }, this._range || this);
            return "ticks" === t185.bounds && $t(s71, this, "value"), t185.reverse ? (s71.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), s71;
        }
        configure() {
            const t = this.ticks;
    ...
    class Jo extends Zo {
        ...
        computeTickLimit() {
            const t = this.isHorizontal(), e = t ? this.width : this.height, i = Yt(this.options.ticks.minRotation), s = (t ? Math.sin(i) : Math.cos(i)) || .001, n = this._resolveTickFontOptions(0);
    ...
    class ta extends Ns {
        ...
        parse(t, e) {
            const i = Zo.prototype.parse.apply(this, [
                t,
                e
            ]);
        ...
        handleTickRangeOptions() {
            const { minDefined: t186 , maxDefined: e145  } = this.getUserBounds();
            let i = this.min, s = this.max;
            const n = (e)=>i = t186 ? i : e, o = (t)=>s = e145 ? s : t, a = (t, e)=>Math.pow(10, Math.floor(Ft(t)) + e);
        ...
        buildTicks() {
            const t187 = this.options, e146 = function(t, e) {
                const i = Math.floor(Ft(e.max)), s = Math.ceil(e.max / Math.pow(10, i)), n = [];
                let o = G(t.min, Math.pow(10, Math.floor(Ft(e.min)))), a = Math.floor(Ft(o)), r = Math.floor(o / Math.pow(10, a)), l = a < 0 ? Math.pow(10, Math.abs(a)) : 1;
                do n.push({
                    value: o,
                    major: Qo(o)
            ...
            return "ticks" === t187.bounds && $t(e146, this, "value"), t187.reverse ? (e146.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), e146;
        }
        getLabelForValue(t) {
    ...
    function sa(t188) {
        const e147 = {
            l: t188.left + t188._padding.left,
            r: t188.right - t188._padding.right,
            t: t188.top + t188._padding.top,
            b: t188.bottom - t188._padding.bottom
        }, i95 = Object.assign({}, e147), s72 = [], n47 = [], o33 = t188._pointLabels.length, a25 = t188.options.pointLabels, r21 = a25.centerPointLabels ? Ot / o33 : 0;
        for(let d6 = 0; d6 < o33; d6++){
            const o = a25.setContext(t188.getPointLabelContext(d6));
            n47[d6] = o.padding;
            const u = t188.getPointPosition(d6, t188.drawingArea + n47[d6], r21), f = ui(o.font), g = (l16 = t188.ctx, h11 = f, c7 = X(c7 = t188._pointLabels[d6]) ? c7 : [
                c7
            ], {
                w: be(l16, h11.string, c7),
                h: c7.length * h11.lineHeight
            });
            s72[d6] = g;
            const p = Zt(t188.getIndexAngle(d6) + r21), m = Math.round(Ut(p));
            na(i95, e147, p, ia(m, u.x, g.w, 0, 180), ia(m, u.y, g.h, 90, 270));
        }
        var l16, h11, c7;
        t188.setCenterPoint(e147.l - i95.l, i95.r - e147.r, e147.t - i95.t, i95.b - e147.b), t188._pointLabelItems = function(t, e, i) {
            const s = [], n = t._pointLabels.length, o = t.options, a = ea(o) / 2, r = t.drawingArea, l = o.pointLabels.centerPointLabels ? Ot / n : 0;
            for(let o32 = 0; o32 < n; o32++){
                const n = t.getPointPosition(o32, r + a + i[o32], l), h = Math.round(Ut(Zt(n.angle + Et))), c = e[o32], d = ra(n.y, c.h, h), u = oa(h), f = aa(n.x, c.w, u);
                s.push({
                    x: n.x,
                    y: d,
                    textAlign: u,
    ...
    class ha extends Zo {
        ...
        setDimensions() {
            const t = this._padding = di(ea(this.options) / 2), e = this.width = this.maxWidth - t.width, i = this.height = this.maxHeight - t.height;
        ...
        generateTickLabels(t189) {
            Zo.prototype.generateTickLabels.call(this, t189), this._pointLabels = this.getLabels().map((t, e)=>{
        ...
        getPointLabelContext(t190) {
            const e148 = this._pointLabels || [];
            if (t190 >= 0 && t190 < e148.length) {
                const i96 = e148[t190];
                return function(t, e, i) {
                    return pi(t, {
                        label: i,
        ...
        drawGrid() {
            const t191 = this.ctx, e149 = this.options, { angleLines: i98 , grid: s73  } = e149, n48 = this._pointLabels.length;
            let o34, a26, r22;
            if (e149.pointLabels.display && function(t, e) {
                const { ctx: i , options: { pointLabels: s  }  } = t;
                for(let n = e - 1; n >= 0; n--){
                    const e = s.setContext(t.getPointLabelContext(n)), o = ui(e.font), { x: a , y: r , textAlign: l , left: h , top: c , right: d , bottom: u  } = t._pointLabelItems[n], { backdropColor: f  } = e;
                    if (!U(f)) {
                        const t192 = ci(e.borderRadius), s = di(e.backdropPadding);
                        i.fillStyle = f;
                        const n = h - s.left, o = c - s.top, a = d - h + s.width, r = u - c + s.height;
                        Object.values(t192).some((t)=>0 !== t) ? (i.beginPath(), Ce(i, {
                            x: n,
                            y: o,
                            w: a,
                            h: r,
            ...
            }(this, n48), s73.display && this.ticks.forEach((t194, e150)=>{
                if (0 !== e150) {
                    a26 = this.getDistanceFromCenterForValue(t194.value);
                    !function(t, e, i, s) {
                    ...
                    }(this, s73.setContext(this.getContext(e150 - 1)), a26, n48);
                }
            }), i98.display) {
                for(t191.save(), o34 = n48 - 1; o34 >= 0; o34--){
                    const s = i98.setContext(this.getPointLabelContext(o34)), { color: n , lineWidth: l  } = s;
                    l && n && (t191.lineWidth = l, t191.strokeStyle = n, t191.setLineDash(s.borderDash), t191.lineDashOffset = s.borderDashOffset, a26 = this.getDistanceFromCenterForValue(e149.ticks.reverse ? this.min : this.max), r22 = this.getPointPosition(o34, a26), t191.beginPath(), t191.moveTo(this.xCenter, this.yCenter), t191.lineTo(r22.x, r22.y), t191.stroke());
                }
                t191.restore();
            }
        }
        drawBorder() {}
        drawLabels() {
            const t = this.ctx, e151 = this.options, i = e151.ticks;
            if (!i.display) return;
            const s74 = this.getIndexAngle(0);
            let n, o;
            t.save(), t.translate(this.xCenter, this.yCenter), t.rotate(s74), t.textAlign = "center", t.textBaseline = "middle", this.ticks.forEach((s, a)=>{
                if (0 === a && !e151.reverse) return;
                const r = i.setContext(this.getContext(a)), l = ui(r.font);
    ...
    function ga(t, e, i, s) {
        ...
        for(let o = da.indexOf(t); o < n - 1; ++o){
            const t = ca[da[o]], n = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
    ...
    function ma(t195, e152, i99) {
        const s75 = [], n49 = {}, o35 = e152.length;
        let a27, r23;
        for(a27 = 0; a27 < o35; ++a27)r23 = e152[a27], n49[r23] = a27, s75.push({
            value: r23,
            major: !1
        });
        return 0 !== o35 && i99 ? function(t, e, i, s) {
            const n = t._adapter, o = +n.startOf(e[0].value, s), a = e[e.length - 1].value;
            let r, l;
            for(r = o; r <= a; r = +n.add(r, 1, s))l = i[r], l >= 0 && (e[l].major = !0);
            return e;
        }(t195, s75, n49, i99) : s75;
    }
    class ba extends Ns {
        constructor(t){
            super(t), this._cache = {
        ...
        init(t, e) {
            const i = t.time || (t.time = {}), s = this._adapter = new xn._date(t.adapters.date);
        ...
        determineDataLimits() {
            const t196 = this.options, e = this._adapter, i = t196.time.unit || "day";
            ...
            o && a || (r(this._getLabelBounds()), "ticks" === t196.bounds && "labels" === t196.ticks.source || r(this.getMinMax(!1))), s = K(s) && !isNaN(s) ? s : +e.startOf(Date.now(), i), n = K(n) && !isNaN(n) ? n : +e.endOf(Date.now(), i) + 1, this.min = Math.min(s, n - 1), this.max = Math.max(s + 1, n);
        }
        _getLabelBounds() {
        ...
        buildTicks() {
            const t197 = this.options, e153 = t197.time, i100 = t197.ticks, s76 = "labels" === i100.source ? this.getLabelTimestamps() : this._generate();
            "ticks" === t197.bounds && s76.length && (this.min = this._userMin || s76[0], this.max = this._userMax || s76[s76.length - 1]);
            const n50 = this.min, o36 = kt(s76, n50, this.max);
            return this._unit = e153.unit || (i100.autoSkip ? ga(e153.minUnit, this.min, this.max, this._getLabelCapacity(n50)) : function(t, e, i, s, n) {
                for(let o = da.length - 1; o >= da.indexOf(i); o--){
                    const i = da[o];
                    if (ca[i].common && t._adapter.diff(n, s, i) >= e - 1) return i;
                }
                return da[i ? da.indexOf(i) : 0];
            }(this, o36.length, e153.minUnit, this.min, this.max)), this._majorUnit = i100.major.enabled && "year" !== this._unit ? function(t) {
                for(let e = da.indexOf(t) + 1, i = da.length; e < i; ++e)if (ca[da[e]].common) return da[e];
            }(this._unit) : void 0, this.initOffsets(s76), t197.reverse && o36.reverse(), ma(this, o36, this._majorUnit);
        }
        afterAutoSkip() {
        ...
        _generate() {
            const t198 = this._adapter, e154 = this.min, i = this.max, s = this.options, n = s.time, o = n.unit || ga(n.minUnit, e154, i, this._getLabelCapacity(e154)), a = Z(n.stepSize, 1), r = "week" === o && n.isoWeekday, l = Wt(r) || !0 === r, h = {};
            let c, d, u = e154;
            if (l && (u = +t198.startOf(u, "isoWeek", r)), u = +t198.startOf(u, l ? "day" : o), t198.diff(i, e154, o) > 1e5 * a) throw new Error(e154 + " and " + i + " are too far apart with stepSize of " + a + " " + o);
            const f = "data" === s.ticks.source && this.getDataTimestamps();
            for(c = u, d = 0; c < i; c = +t198.add(c, a, o), d++)pa(h, c, f);
        ...
        _getLabelSize(t) {
            const e = this.options.ticks, i = this.ctx.measureText(t).width, s = Yt(this.isHorizontal() ? e.maxRotation : e.minRotation), n = Math.cos(s), o = Math.sin(s), a = this._resolveTickFontOptions(0).size;
            return {
                w: i * n + a * o,
                h: i * o + a * n
            };
        ...
        _getLabelCapacity(t) {
            const e = this.options.time, i = e.displayFormats, s = i[e.unit] || i.millisecond, n = this._tickFormatFunction(t, 0, ma(this, [
                t
    ...
    function xa(t, e, i) {
        ...
        i ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r , hi: l  } = wt(t, "pos", e)), { pos: s , time: o  } = t[r], { pos: n , time: a  } = t[l]) : (e >= t[r].time && e <= t[l].time && ({ lo: r , hi: l  } = wt(t, "time", e)), { time: s , pos: o  } = t[r], { time: n , pos: a  } = t[l]);
        const h = n - s;
    ...
    return fn.register(In, ya, ao, Xo), fn.helpers = {
        ...Di
    }, fn._adapters = xn, fn.Animation = gs, fn.Animations = ms, fn.animator = a1, fn.controllers = Hs.controllers.items, fn.DatasetController = Cs, fn.Element = Os, fn.elements = ao, fn.Interaction = Ei, fn.layouts = Xi, fn.platforms = ds, fn.Scale = Ns, fn.Ticks = Ts, Object.assign(fn, In, ya, ao, Xo, ds), fn.Chart = fn, "undefined" != typeof window && (window.Chart = fn), fn;
});

},{}]},["3JrbZ","9MdVg"], "9MdVg", "parcelRequire807c")

//# sourceMappingURL=index.8da040e4.js.map
